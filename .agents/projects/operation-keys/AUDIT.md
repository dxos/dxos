...
| `org.dxos.operation.agent.getContext`                    | `@dxos/assistant-toolkit`        | `skills/agent/operations/definitions.ts`                          | Get Agent Context               |       |
| `org.dxos.operation.agent.relay`                         | `@dxos/assistant-toolkit`        | `skills/agent/operations/definitions.ts`                          | Agent Relay                     |       |
| `org.dxos.operation.agent.syncTriggers`                  | `@dxos/assistant-toolkit`        | `skills/agent-wizard/operations/definitions.ts`                   | Sync automation                 | ✓     |
| `org.dxos.operation.agentWizard.agentRules`              | `@dxos/assistant-toolkit`        | `skills/agent-wizard/operations/definitions.ts`                   | Agent rules                     | ✓     |
| `org.dxos.operation.agentWizard.createAgent`             | `@dxos/assistant-toolkit`        | `skills/agent-wizard/operations/definitions.ts`                   | Create agent                    | ✓     |
| `org.dxos.operation.alarm.getCurrentDate`                | `@dxos/assistant-toolkit`        | `skills/alarm/operations/definitions.ts`                          | Get current date                | ✓     |
| `org.dxos.operation.alarm.setAlarm`                      | `@dxos/assistant-toolkit`        | `skills/alarm/operations/definitions.ts`                          | Set alarm                       | ✓     |
...
| `org.dxos.operation.assistant.runInstructions`           | `@dxos/assistant-toolkit`        | `operations/definitions.ts`                                       | Run Instructions                |       |
| `org.dxos.operation.assistant.setCurrentChat`            | `@dxos/plugin-assistant`         | `types/AssistantOperation.ts`                                     | Set Current Chat                |       |
| `org.dxos.operation.assistant.toggleTracePanelDebug`     | `@dxos/plugin-assistant`         | `types/AssistantOperation.ts`                                     | Toggle trace panel debug        |       |
...
| `org.dxos.operation.bluesky.getBlueskyTargets`           | `@dxos/plugin-bluesky`           | `operations/definitions.ts`                                       | Get Bluesky Targets             |       |
| `org.dxos.operation.bluesky.materializeBlueskyTarget`    | `@dxos/plugin-bluesky`           | `operations/definitions.ts`                                       | Materialize Bluesky Target      |       |
| `org.dxos.operation.bluesky.syncBlueskyTargets`          | `@dxos/plugin-bluesky`           | `operations/definitions.ts`                                       | Sync Bluesky                    |       |
...
| `org.dxos.operation.chess.commentary`                    | `@dxos/plugin-script`            | `templates/commentary.ts`                                         | Commentary                      |       |
...
| `org.dxos.operation.countReplies`                        | `@dxos/agent-runtime`            | `functions.test.ts`                                               | Count Replies                   | ✓     |
...
| `org.dxos.operation.database.contextAdd`                 | `@dxos/assistant-toolkit`        | `skills/chat-context/operations/definitions.ts`                   | Add to context                  | ✓     |
| `org.dxos.operation.database.contextRemove`              | `@dxos/assistant-toolkit`        | `skills/chat-context/operations/definitions.ts`                   | Remove from context             | ✓     |
| `org.dxos.operation.deck.adjust`                         | `@dxos/plugin-deck`              | `types/DeckOperation.ts`                                          | Adjust                          |       |
| `org.dxos.operation.deck.toggleExpose`                   | `@dxos/plugin-deck`              | `types/DeckOperation.ts`                                          | Toggle Exposé                   |       |
...
| `org.dxos.operation.delegatedWork`                       | `@dxos/agent-runtime`            | `agent-service/AgentService.test.ts`                              | Delegated work                  |       |
| `org.dxos.operation.delegatedWork`                       | `@dxos/agent-runtime`            | `agent-service/delegation-scripted.test.ts`                       | Delegated work                  |       |
| `org.dxos.operation.delegation.delegateTask`             | `@dxos/assistant-toolkit`        | `skills/delegation/operations/definitions.ts`                     | Delegate task                   | ✓     |
| `org.dxos.operation.discord.crawlDiscordChannels`        | `@dxos/plugin-discord`           | `types/DiscordOperation.ts`                                       | Crawl Discord Channels          |       |
| `org.dxos.operation.discord.getDiscordChannels`          | `@dxos/plugin-discord`           | `types/DiscordOperation.ts`                                       | Get Discord Channels            |       |
| `org.dxos.operation.discord.materializeDiscordTarget`    | `@dxos/plugin-discord`           | `types/DiscordOperation.ts`                                       | Materialize Discord Target      |       |
| `org.dxos.operation.discord.syncDiscordChannel`          | `@dxos/plugin-discord`           | `types/DiscordOperation.ts`                                       | Sync Discord Channel            |       |
...
| `org.dxos.operation.github.getGithubRepositories`        | `@dxos/plugin-github`            | `types/GitHubOperation.ts`                                        | Get GitHub Repositories         |       |
| `org.dxos.operation.github.materializeGithubTarget`      | `@dxos/plugin-github`            | `types/GitHubOperation.ts`                                        | Materialize GitHub Target       |       |
| `org.dxos.operation.github.syncGithubRepositories`       | `@dxos/plugin-github`            | `types/GitHubOperation.ts`                                        | Sync GitHub Repositories        |       |
| `org.dxos.operation.google.createGoogleCalendarEvent`    | `@dxos/plugin-google`            | `types/GoogleOperation.ts`                                        | Create Google Calendar Event    |       |
| `org.dxos.operation.google.getGoogleCalendars`           | `@dxos/plugin-google`            | `types/GoogleOperation.ts`                                        | Get Google Calendars            |       |
| `org.dxos.operation.google.getGoogleContactGroups`       | `@dxos/plugin-google`            | `types/GoogleOperation.ts`                                        | Get Google Contact Groups       |       |
| `org.dxos.operation.google.googleCalendarSync`           | `@dxos/plugin-google`            | `types/GoogleOperation.ts`                                        | Sync Google Calendar            |       |
| `org.dxos.operation.google.googleContactsSync`           | `@dxos/plugin-google`            | `types/GoogleOperation.ts`                                        | Sync Google Contacts            |       |
| `org.dxos.operation.google.googleMailSend`               | `@dxos/plugin-google`            | `types/GoogleOperation.ts`                                        | Send Gmail                      |       |
| `org.dxos.operation.google.googleMailSync`               | `@dxos/plugin-google`            | `types/GoogleOperation.ts`                                        | Sync Google Mail                |       |
...
| `org.dxos.operation.inbox.testing.stub`                  | `@dxos/plugin-inbox`             | `operations/analyze/analyze-mailbox.test.ts`                      | Stub                            |       |
| `org.dxos.operation.inbox.unsubscribeSender`             | `@dxos/plugin-inbox`             | `types/InboxOperation.ts`                                         | Unsubscribe                     |       |
| `org.dxos.operation.jmap.jmapSend`                       | `@dxos/plugin-jmap`              | `types/JmapOperation.ts`                                          | Send JMAP                       |       |
| `org.dxos.operation.jmap.jmapSync`                       | `@dxos/plugin-jmap`              | `types/JmapOperation.ts`                                          | Sync JMAP                       |       |
| `org.dxos.operation.jmap.materializeJmapTarget`          | `@dxos/plugin-jmap`              | `types/JmapOperation.ts`                                          | Materialize JMAP Target         |       |
...
| `org.dxos.operation.linear.getLinearTeams`               | `@dxos/plugin-linear`            | `types/LinearOperation.ts`                                        | Get Linear Teams                |       |
| `org.dxos.operation.linear.materializeLinearTarget`      | `@dxos/plugin-linear`            | `types/LinearOperation.ts`                                        | Materialize Linear Target       |       |
| `org.dxos.operation.linear.syncLinearTeams`              | `@dxos/plugin-linear`            | `types/LinearOperation.ts`                                        | Sync Linear Teams               |       |
...
| `org.dxos.operation.magazine.clearMagazine`              | `@dxos/plugin-magazine`          | `types/FeedOperation.ts`                                          | Clear Magazine                  |       |
| `org.dxos.operation.magazine.curateMagazine`             | `@dxos/plugin-magazine`          | `types/FeedOperation.ts`                                          | Curate Magazine                 |       |
...
| `org.dxos.operation.map.toggle`                          | `@dxos/plugin-map`               | `types/MapOperation.ts`                                           | Toggle Map                      |       |
| `org.dxos.operation.markdown.create`                     | `@dxos/compute`                  | `Operation.test.ts`                                               | Something Else Entirely         |       |
...
| `org.dxos.operation.memory.delete`                       | `@dxos/assistant-toolkit`        | `skills/memory/operations/definitions.ts`                         | Delete memory                   | ✓     |
| `org.dxos.operation.memory.query`                        | `@dxos/assistant-toolkit`        | `skills/memory/operations/definitions.ts`                         | Query memories                  | ✓     |
| `org.dxos.operation.memory.save`                         | `@dxos/assistant-toolkit`        | `skills/memory/operations/definitions.ts`                         | Save memory                     | ✓     |
| `org.dxos.operation.nativeFilesystem.closeDirectory`     | `@dxos/plugin-native-filesystem` | `types/NativeFilesystemOperation.ts`                              | Close Folder                    |       |
| `org.dxos.operation.nativeFilesystem.openDirectory`      | `@dxos/plugin-native-filesystem` | `types/NativeFilesystemOperation.ts`                              | Open Folder                     |       |
...
| `org.dxos.operation.observability.toggle`                | `@dxos/plugin-observability`     | `types/ObservabilityOperation.ts`                                 | Toggle Observability            |       |
| `org.dxos.operation.organizationList`                    | `@dxos/agent-runtime`            | `assistant-session-tests/format.test.ts`                          | Organization List               |       |
| `org.dxos.operation.planning.planReminder`               | `@dxos/assistant-toolkit`        | `skills/planning/operations/definitions.ts`                       | Plan reminder                   |       |
| `org.dxos.operation.planning.updateTasks`                | `@dxos/assistant-toolkit`        | `skills/planning/operations/definitions.ts`                       | Update tasks                    | ✓     |
| `org.dxos.operation.presenter.togglePresentation`        | `@dxos/plugin-presenter`         | `types/PresenterOperation.ts`                                     | Toggle Presentation             |       |
| `org.dxos.operation.project.artifactAdd`                 | `@dxos/assistant-toolkit`        | `skills/project/operations/definitions.ts`                        | Add project artifact            | ✓     |
| `org.dxos.operation.project.artifactList`                | `@dxos/assistant-toolkit`        | `skills/project/operations/definitions.ts`                        | List project artifacts          | ✓     |
| `org.dxos.operation.projects.createChat`                 | `@dxos/plugin-projects`          | `types/ProjectOperation.ts`                                       | Create Project Chat             |       |
| `org.dxos.operation.projects.createTrackingProject`      | `@dxos/plugin-projects`          | `types/ProjectOperation.ts`                                       | Create Tracking Project         |       |
| `org.dxos.operation.projects.projectCreate`              | `@dxos/plugin-projects`          | `types/ProjectOperation.ts`                                       | Create Project                  | ✓     |
| `org.dxos.operation.projects.projectGet`                 | `@dxos/plugin-projects`          | `types/ProjectMcpOperation.ts`                                    | Get Project                     | ✓     |
| `org.dxos.operation.projects.projectList`                | `@dxos/plugin-projects`          | `types/ProjectMcpOperation.ts`                                    | List Projects                   | ✓     |
| `org.dxos.operation.projects.projectUpdate`              | `@dxos/plugin-projects`          | `types/ProjectMcpOperation.ts`                                    | Update Project                  | ✓     |
| `org.dxos.operation.projects.updateInvestorLog`          | `@dxos/plugin-projects`          | `types/ProjectOperation.ts`                                       | Update Investor Log             |       |
| `org.dxos.operation.projects.updateProjectTasks`         | `@dxos/plugin-projects`          | `types/ProjectOperation.ts`                                       | Update Project Tasks            |       |
| `org.dxos.operation.projects.updateTravelLog`            | `@dxos/plugin-projects`          | `types/ProjectOperation.ts`                                       | Update Travel Log               |       |
| `org.dxos.operation.readName`                            | `@dxos/agent-runtime`            | `functions.test.ts`                                               | Read Name                       | ✓     |
| `org.dxos.operation.registry.queryPlugins`               | `@dxos/plugin-registry`          | `operations/definitions.ts`                                       | Query Plugins                   | ✓     |
| `org.dxos.operation.research`                            | `@dxos/agent-runtime`            | `agent-service/AgentService.test.ts`                              | Research                        | ✓     |
...
| `org.dxos.operation.review.toggleResolved`               | `@dxos/plugin-review`            | `types/CommentOperation.ts`                                       | Toggle Resolved                 |       |
...
| `org.dxos.operation.sample.createSampleItem`             | `@dxos/plugin-sample`            | `types/SampleOperation.ts`                                        | Create Sample Item              |       |
...
| `org.dxos.operation.script.create`                       | `@dxos/plugin-script`            | `skills/functions/definitions.ts`                                 | Create                          | ✓     |
| `org.dxos.operation.script.createScript`                 | `@dxos/plugin-script`            | `types/ScriptOperation.ts`                                        | Create Script                   |       |
...
| `org.dxos.operation.script.forexEffect`                  | `@dxos/functions-testing`        | `functions/forex-effect.ts`                                       | Forex Effect                    |       |
| `org.dxos.operation.script.forexEffect`                  | `@dxos/plugin-script`            | `templates/forex-effect.ts`                                       | Forex Effect                    |       |
...
| `org.dxos.operation.script.myFunction`                   | `@dxos/plugin-script`            | `skills/functions/definitions.ts`                                 | My Function                     |       |
...
| `org.dxos.operation.search.openSearch`                   | `@dxos/plugin-search`            | `types/SearchOperation.ts`                                        | Open Search                     |       |
...
| `org.dxos.operation.sheet.rangeGet`                      | `@dxos/plugin-sheet`             | `types/SheetOperation.ts`                                         | Get Range Values                | ✓     |
| `org.dxos.operation.sheet.rangeSet`                      | `@dxos/plugin-sheet`             | `types/SheetOperation.ts`                                         | Set Range Values                | ✓     |
...
| `org.dxos.operation.skillManager.enableSkills`           | `@dxos/assistant-toolkit`        | `skills/skill-manager/operations/definitions.ts`                  | Enable skills                   | ✓     |
| `org.dxos.operation.skillManager.querySkills`            | `@dxos/assistant-toolkit`        | `skills/skill-manager/operations/definitions.ts`                  | Query skills                    | ✓     |
| `org.dxos.operation.slack.getSlackChannels`              | `@dxos/plugin-slack`             | `types/SlackOperation.ts`                                         | Get Slack Channels              |       |
| `org.dxos.operation.slack.materializeSlackTarget`        | `@dxos/plugin-slack`             | `types/SlackOperation.ts`                                         | Materialize Slack Target        |       |
| `org.dxos.operation.slack.syncSlackChannel`              | `@dxos/plugin-slack`             | `types/SlackOperation.ts`                                         | Sync Slack Channel              |       |
...
| `org.dxos.operation.space.archive`                       | `@dxos/mcp-server`               | `McpServer.test.ts`                                               | Archive Space                   |       |
...
| `org.dxos.operation.space.exportSpace`                   | `@dxos/plugin-space`             | `types/SpaceOperation.ts`                                         | Export Space                    |       |
...
| `org.dxos.operation.space.importSpace`                   | `@dxos/plugin-space`             | `types/SpaceOperation.ts`                                         | Import Space                    |       |
...
| `org.dxos.operation.space.openCreateSpace`               | `@dxos/plugin-space`             | `types/SpaceOperation.ts`                                         | Open Create Space Dialog        |       |
| `org.dxos.operation.space.openImportSpace`               | `@dxos/plugin-space`             | `types/SpaceOperation.ts`                                         | Open Import Space Dialog        |       |
...
| `org.dxos.operation.storiesBrain.retrieveSubject`        | `@dxos/stories-brain`            | `testing/harness/skills/hybrid-skill.ts`                          | Retrieve Subject                | ✓     |
...
| `org.dxos.operation.tasks.convertToTask`                 | `@dxos/plugin-tasks`             | `types/OutlineOperation.ts`                                       | Convert to Task                 |       |
| `org.dxos.operation.tasks.createOutline`                 | `@dxos/plugin-tasks`             | `types/OutlineOperation.ts`                                       | Create Outline                  |       |
| `org.dxos.operation.tasks.milestoneCreate`               | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Create Milestone                | ✓     |
| `org.dxos.operation.tasks.milestoneDelete`               | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Delete Milestone                | ✓     |
| `org.dxos.operation.tasks.milestoneList`                 | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | List Milestones                 | ✓     |
| `org.dxos.operation.tasks.milestoneMove`                 | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Move Milestone                  | ✓     |
| `org.dxos.operation.tasks.milestoneUpdate`               | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Update Milestone                | ✓     |
| `org.dxos.operation.tasks.outlineGet`                    | `@dxos/plugin-tasks`             | `types/OutlineOperation.ts`                                       | Get Outline                     | ✓     |
| `org.dxos.operation.tasks.outlineUpdate`                 | `@dxos/plugin-tasks`             | `types/OutlineOperation.ts`                                       | Update Outline                  | ✓     |
| `org.dxos.operation.tasks.quickEntry`                    | `@dxos/plugin-tasks`             | `types/OutlineOperation.ts`                                       | Quick Journal Entry             |       |
| `org.dxos.operation.tasks.taskAssign`                    | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Assign Task                     | ✓     |
| `org.dxos.operation.tasks.taskComplete`                  | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Complete Task                   | ✓     |
| `org.dxos.operation.tasks.taskCreate`                    | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Create Task                     | ✓     |
| `org.dxos.operation.tasks.taskDelete`                    | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Delete Task                     |       |
| `org.dxos.operation.tasks.taskList`                      | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | List Tasks                      | ✓     |
| `org.dxos.operation.tasks.taskMove`                      | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Move Task                       |       |
| `org.dxos.operation.tasks.taskUpdate`                    | `@dxos/plugin-tasks`             | `types/TaskOperation.ts`                                          | Update Task                     | ✓     |
| `org.dxos.operation.test.add`                            | `@dxos/app-framework`            | `plugin-process-manager/testing.ts`                               | —                               |       |
| `org.dxos.operation.test.Binding.sync.sync`              | `@dxos/plugin-connector`         | `Binding.test.ts`                                                 | Test Sync                       |       |
| `org.dxos.operation.test.bindingLifecycle.sync`          | `@dxos/plugin-connector`         | `Binding.test.ts`                                                 | Test Sync                       |       |
| `org.dxos.operation.test.childPassthrough`               | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | ChildPassthrough                |       |
| `org.dxos.operation.test.compute`                        | `@dxos/app-framework`            | `plugin-process-manager/testing.ts`                               | —                               |       |
| `org.dxos.operation.test.compute.add`                    | `@dxos/compute-hyperformula`     | `compute-graph-registry.test.ts`                                  | add                             |       |
| `org.dxos.operation.test.connectorAuth.sync`             | `@dxos/plugin-connector`         | `ConnectorAuth.test.ts`                                           | Test Sync                       |       |
| `org.dxos.operation.test.connectorAuthGraph.sync`        | `@dxos/plugin-connector`         | `capabilities/connector-auth-actions.test.ts`                     | Test Sync                       |       |
| `org.dxos.operation.test.createSingleCursor.materialize` | `@dxos/plugin-connector`         | `capabilities/connector-coordinator/create-single-cursor.test.ts` | —                               |       |
| `org.dxos.operation.test.createSingleCursor.sync`        | `@dxos/plugin-connector`         | `capabilities/connector-coordinator/create-single-cursor.test.ts` | —                               |       |
| `org.dxos.operation.test.deployedDouble`                 | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | DeployedDouble                  |       |
| `org.dxos.operation.test.double`                         | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | Double                          |       |
| `org.dxos.operation.test.failing`                        | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | Failing                         |       |
| `org.dxos.operation.test.halveCompute`                   | `@dxos/app-framework`            | `plugin-process-manager/testing.ts`                               | —                               |       |
| `org.dxos.operation.test.invoker.child`                  | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | Child                           |       |
| `org.dxos.operation.test.invoker.parent`                 | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | Parent                          |       |
| `org.dxos.operation.test.logger.log`                     | `@dxos/app-toolkit`              | `playground/logger/schema.ts`                                     | Log                             |       |
| `org.dxos.operation.test.materializeExampleTarget`       | `@dxos/plugin-connector`         | `capabilities/connector-coordinator/reconcile-cursors.test.ts`    | —                               |       |
| `org.dxos.operation.test.mixed`                          | `@dxos/assistant`                | `tool-runtime/services.test.ts`                                   | —                               |       |
| `org.dxos.operation.test.noParams`                       | `@dxos/assistant`                | `tool-runtime/services.test.ts`                                   | —                               |       |
| `org.dxos.operation.test.notDeployed`                    | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | NotDeployed                     |       |
| `org.dxos.operation.test.pageAction`                     | `@dxos/plugin-crx`               | `page-actions.test.ts`                                            | Test                            |       |
| `org.dxos.operation.test.parentInvoker`                  | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | ParentInvoker                   |       |
| `org.dxos.operation.test.propertyBag`                    | `@dxos/assistant`                | `tool-runtime/services.test.ts`                                   | —                               |       |
| `org.dxos.operation.test.reconcileCursors.sync`          | `@dxos/plugin-connector`         | `capabilities/connector-coordinator/reconcile-cursors.test.ts`    | —                               |       |
| `org.dxos.operation.test.recursive`                      | `@dxos/assistant`                | `tool-runtime/services.test.ts`                                   | —                               |       |
| `org.dxos.operation.test.rename`                         | `@dxos/plugin-observability`     | `capabilities/invocation-listener.test.ts`                        | —                               |       |
| `org.dxos.operation.test.runAgain`                       | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | RunAgain                        |       |
| `org.dxos.operation.test.runnable`                       | `@dxos/plugin-routine`           | `operations/run-routine.test.ts`                                  | Test Runnable                   |       |
| `org.dxos.operation.test.sideEffect`                     | `@dxos/app-framework`            | `plugin-process-manager/testing.ts`                               | —                               |       |
| `org.dxos.operation.test.slowChild`                      | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | SlowChild                       |       |
| `org.dxos.operation.test.slowIdempotent`                 | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | SlowIdempotent                  |       |
| `org.dxos.operation.test.slowNonIdempotent`              | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | SlowNonIdempotent               |       |
| `org.dxos.operation.test.sync`                           | `@dxos/plugin-connector`         | `Binding.test.ts`                                                 | Test Sync                       |       |
| `org.dxos.operation.test.syncFanout.sync`                | `@dxos/plugin-connector`         | `Binding.test.ts`                                                 | Test Sync                       |       |
| `org.dxos.operation.test.syncTemplate.sync`              | `@dxos/plugin-connector`         | `SyncTemplate.test.ts`                                            | Test Sync                       |       |
| `org.dxos.operation.test.targetConnectors.sync`          | `@dxos/plugin-connector`         | `types/ConnectorSpec.test.ts`                                     | Test Sync                       |       |
| `org.dxos.operation.test.toString`                       | `@dxos/app-framework`            | `plugin-process-manager/testing.ts`                               | —                               |       |
| `org.dxos.operation.test.untracked`                      | `@dxos/plugin-observability`     | `capabilities/invocation-listener.test.ts`                        | —                               |       |
| `org.dxos.operation.test.withLiveRef`                    | `@dxos/compute-runtime`          | `ProcessManager.test.ts`                                          | WithLiveRef                     |       |
...
| `org.dxos.operation.trello.getTrelloBoards`              | `@dxos/plugin-trello`            | `types/TrelloOperation.ts`                                        | Get Trello Boards               |       |
| `org.dxos.operation.trello.materializeTrelloTarget`      | `@dxos/plugin-trello`            | `types/TrelloOperation.ts`                                        | Materialize Trello Target       |       |
| `org.dxos.operation.trello.syncTrelloBoard`              | `@dxos/plugin-trello`            | `types/TrelloOperation.ts`                                        | Sync Trello Board               |       |
| `org.dxos.operation.trip.addSegment`                     | `@dxos/plugin-trip`              | `types/TripOperation.ts`                                          | Add segment                     | ✓     |
| `org.dxos.operation.trip.createTripFromEvents`           | `@dxos/plugin-trip`              | `types/TripOperation.ts`                                          | Create trip from events         |       |
| `org.dxos.operation.trip.extractTrip`                    | `@dxos/plugin-trip`              | `types/TripOperation.ts`                                          | Extract Trip                    |       |
| `org.dxos.operation.trip.mergeTrip`                      | `@dxos/plugin-trip`              | `types/TripOperation.ts`                                          | Merge trip                      |       |
...
| `org.dxos.operation.voxel.addVoxels`                     | `@dxos/plugin-voxel`             | `types/VoxelOperation.ts`                                         | Add voxels                      | ✓     |
...
| `org.dxos.operation.voxel.removeVoxels`                  | `@dxos/plugin-voxel`             | `types/VoxelOperation.ts`                                         | Remove voxels                   | ✓     |
| `org.dxos.operation.webSearch.fetch`                     | `@dxos/assistant-toolkit`        | `skills/websearch/operations/definitions.ts`                      | Fetch web page                  | ✓     |
| `org.dxos.stories-brain.operation.retrieveSnippets`      | `@dxos/stories-brain`            | `testing/harness/skills/rag-skill.ts`                             | Retrieve Snippets               | ✓     |
| `org.example.operation.registry.queryPlugins`            | `@dxos/mcp-server`               | `McpServer.test.ts`                                               | Query Plugins                   |       |
| `org.example.operation.triggerDispatcher.probeDatabase`  | `@dxos/compute-runtime`          | `triggers/trigger-dispatcher.test.ts`                             | Probe Database                  |       |
| `org.example.operation.triggerDispatcher.retry`          | `@dxos/compute-runtime`          | `triggers/trigger-dispatcher.test.ts`                             | Retry                           |       |
| `org.example.operation.triggerDispatcher.subjectProbe`   | `@dxos/compute-runtime`          | `triggers/trigger-dispatcher.test.ts`                             | Subject Probe                   |       |
