...
panels = {
  "stat-clients": number("Clients reporting", "Number of distinct metric streams in the window \u2014 one per client realm exporting client-level gauges. Counts series, not people: a client that reloads and gets a new deviceKey counts twice, and a client that went away mid-window still counts. This is the denominator for every 'per client' panel below \u2014 an average that moves while this moves is a population change, not a behaviour change.", [
