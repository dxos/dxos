...
_Resume: watch dxos#12449 CI to green and land; edge#790 stays red until a dxos release carries the migrations (then bump edge's catalog and merge). Uncommitted: none. Last: design consolidated into DESIGN.md here; cross-version interop proven for all 9 packages / 18 stores._
...
- [x] **Durable Object verification** — `feed-migrations.workerd.test.ts` in
      edge#790 against real DO SQL storage via linked packages (db-service 140/140).
