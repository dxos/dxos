...
Audits of the DXOS theme (surfaces, density) against shadcn/ui and Ark UI, and the dx-preview hover
card. The Tree rebuild design was factored out to `packages/ui/react-ui-list/docs/TREE.md` (#12873).
