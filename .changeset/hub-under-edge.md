...
keeps `auth_url` alone, since the passkey origin cannot be derived from the API host.
...
presence of a hub URL, which also gates the account, invitations and usage panels.
