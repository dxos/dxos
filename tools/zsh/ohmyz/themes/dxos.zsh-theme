# DXOS ZSH Theme
# Forked from: https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/avit.zsh-theme
...
function dxos_prompt_info() {
  if [[ -n $DX_PROFILE ]]; then
    echo "[%{$fg[red]%}$(printenv DX_PROFILE)%{$reset_color%}] "
  fi
}

PROMPT='
$(dxos_prompt_info)$(_user_host)${_current_dir}$(git_prompt_info)
