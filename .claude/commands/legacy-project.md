---
description: Task-planning projects — status, tasks, list, new, end, track, hydrate, resume
...
`(bare) | list [all] | tasks [all] | new <name> | end <name> | track <text> | hydrate | resume [name]` was
