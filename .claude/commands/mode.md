...
```bash
bash .claude/scripts/mode.sh get; bash .claude/scripts/mode.sh focus get; bash .claude/scripts/mode.sh phase get; bash .claude/scripts/mode.sh servers; git rev-parse --show-toplevel; git branch --show-current; ls -1 AGENTS.md .claude/CLAUDE.md ~/.claude/CLAUDE.md 2>/dev/null
```
