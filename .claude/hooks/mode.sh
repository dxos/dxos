...
# 1c. Phase: `/mode discuss|build|debug` sets the phase only, leaving verbosity
#    and any focus pin untouched; `/mode focus` also sets the phase to build,
#    since a pinned task is something to execute.
