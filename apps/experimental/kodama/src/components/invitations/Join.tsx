...
import { InvitationDescriptorWrapper, PartyInvitation, PartyKey } from '@dxos/client';
  ...
  const handleDecode = () => {
    try {
      ...
      try {
        ...
        const invitation = client.echo.acceptInvitation(InvitationDescriptorWrapper.decode(stripped));
