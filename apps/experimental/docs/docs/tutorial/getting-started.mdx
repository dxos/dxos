...
---
import 'setimmediate';
import * as SanityApp from '@dxos/sanity/src/SanityApp.jsx?@dxos/showcase';
...
<ShowcaseComponent 
  component={SanityApp.component} 
  rawContent={SanityApp.rawContent} 
  collapsible={true}
  collapsibleDefaultOpened={false}
  githubUrl={'https://github.com/dxos/dxos'}
/>
