...
[packages/echo/echo-db/src/packlets/errors/errors.ts:22](https://github.com/dxos/dxos/blob/b06737400/packages/echo/echo-db/src/packlets/errors/errors.ts#L22)
