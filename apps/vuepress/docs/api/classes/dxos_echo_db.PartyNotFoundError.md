...
[packages/echo/echo-db/src/packlets/errors/errors.ts:10](https://github.com/dxos/dxos/blob/e3b936721/packages/echo/echo-db/src/packlets/errors/errors.ts#L10)
