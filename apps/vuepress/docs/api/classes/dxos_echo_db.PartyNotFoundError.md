...
[@dxos/echo-db](../modules/dxos_echo_db.md).PartyNotFoundError
...
- [constructor](dxos_echo_db.PartyNotFoundError.md#constructor)

### Properties

- [cause](dxos_echo_db.PartyNotFoundError.md#cause)
- [code](dxos_echo_db.PartyNotFoundError.md#code)
- [dxosErrorMessage](dxos_echo_db.PartyNotFoundError.md#dxoserrormessage)
- [message](dxos_echo_db.PartyNotFoundError.md#message)
- [name](dxos_echo_db.PartyNotFoundError.md#name)
- [stack](dxos_echo_db.PartyNotFoundError.md#stack)
- [prepareStackTrace](dxos_echo_db.PartyNotFoundError.md#preparestacktrace)
- [stackTraceLimit](dxos_echo_db.PartyNotFoundError.md#stacktracelimit)

### Methods

- [captureStackTrace](dxos_echo_db.PartyNotFoundError.md#capturestacktrace)

## Constructors

### constructor

• **new PartyNotFoundError**(`partyKey`)
...
[packages/echo/echo-db/src/packlets/errors/errors.ts:10](https://github.com/dxos/dxos/blob/32ae9b579/packages/echo/echo-db/src/packlets/errors/errors.ts#L10)
