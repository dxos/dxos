...
[packages/echo/echo-db/src/packlets/errors/errors.ts:22](https://github.com/dxos/dxos/blob/32ae9b579/packages/echo/echo-db/src/packlets/errors/errors.ts#L22)
