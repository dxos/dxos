...
- [cause](EntityNotFoundError.md#cause)
- [code](EntityNotFoundError.md#code)
- [dxosErrorMessage](EntityNotFoundError.md#dxoserrormessage)
...
[packages/echo/echo-db/src/packlets/errors/errors.ts:16](https://github.com/dxos/dxos/blob/6b1348fed/packages/echo/echo-db/src/packlets/errors/errors.ts#L16)
