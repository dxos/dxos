...
- [constructor](InvalidInvitationError.md#constructor)

### Properties

- [cause](InvalidInvitationError.md#cause)
- [code](InvalidInvitationError.md#code)
- [dxosErrorMessage](InvalidInvitationError.md#dxoserrormessage)
- [message](InvalidInvitationError.md#message)
- [name](InvalidInvitationError.md#name)
- [stack](InvalidInvitationError.md#stack)
- [prepareStackTrace](InvalidInvitationError.md#preparestacktrace)
- [stackTraceLimit](InvalidInvitationError.md#stacktracelimit)

### Methods

- [captureStackTrace](InvalidInvitationError.md#capturestacktrace)
...
[packages/echo/echo-db/src/packlets/errors/errors.ts:34](https://github.com/dxos/dxos/blob/6b1348fed/packages/echo/echo-db/src/packlets/errors/errors.ts#L34)
