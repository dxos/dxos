...
- [constructor](PartyNotFoundError.md#constructor)

### Properties

- [cause](PartyNotFoundError.md#cause)
- [code](PartyNotFoundError.md#code)
- [dxosErrorMessage](PartyNotFoundError.md#dxoserrormessage)
- [message](PartyNotFoundError.md#message)
- [name](PartyNotFoundError.md#name)
- [stack](PartyNotFoundError.md#stack)
- [prepareStackTrace](PartyNotFoundError.md#preparestacktrace)
- [stackTraceLimit](PartyNotFoundError.md#stacktracelimit)

### Methods

- [captureStackTrace](PartyNotFoundError.md#capturestacktrace)
...
[packages/echo/echo-db/src/packlets/errors/errors.ts:10](https://github.com/dxos/dxos/blob/6b1348fed/packages/echo/echo-db/src/packlets/errors/errors.ts#L10)
