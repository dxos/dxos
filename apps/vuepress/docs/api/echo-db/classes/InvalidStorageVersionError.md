...
- [constructor](InvalidStorageVersionError.md#constructor)

### Properties

- [cause](InvalidStorageVersionError.md#cause)
- [code](InvalidStorageVersionError.md#code)
- [dxosErrorMessage](InvalidStorageVersionError.md#dxoserrormessage)
- [message](InvalidStorageVersionError.md#message)
- [name](InvalidStorageVersionError.md#name)
- [stack](InvalidStorageVersionError.md#stack)
- [prepareStackTrace](InvalidStorageVersionError.md#preparestacktrace)
- [stackTraceLimit](InvalidStorageVersionError.md#stacktracelimit)

### Methods

- [captureStackTrace](InvalidStorageVersionError.md#capturestacktrace)
...
[packages/echo/echo-db/src/packlets/errors/errors.ts:40](https://github.com/dxos/dxos/blob/6b1348fed/packages/echo/echo-db/src/packlets/errors/errors.ts#L40)
