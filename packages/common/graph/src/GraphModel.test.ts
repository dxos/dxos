...
describe('subgraph', () => {
  ...
  const build = () => {
    ...
    model.addEdges([
      { id: 'e1', type: 'child', source: 'root', target: 'a' },
      { id: 'e2', type: 'child', source: 'a', target: 'a1' },
      { id: 'e3', type: 'action', source: 'a', target: 'a2' },
      { id: 'e4', type: 'child', source: 'root', target: 'b' },
      { id: 'e5', type: 'child', source: 'b', target: 'b1' },
    ]);
    return model;
  };
