...
export const buttonClassName = ({ variant, disabled }: ButtonProps) => {
  ...
  return cx(
    ...
    resolvedVariant === 'default' && 'border border-neutral-100 bg-white text-neutral-900 hover:bg-neutral-50 dark:border-neutral-650 dark:bg-neutral-750 dark:text-neutral-50 dark:hover:bg-neutral-800',
