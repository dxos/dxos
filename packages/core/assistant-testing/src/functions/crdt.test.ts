...
describe('MarkdownTaskManager', () => {
  ...
  it('should update task text', () => {
    const manager = new MarkdownTaskManager('- [ ] Old task');
  ...
  it('should handle hierarchical task structure', () => {
    const manager = new MarkdownTaskManager();
