...
import { DEFAULT_EDGE_MODELS, DEFAULT_OLLAMA_MODELS, DEFAULT_LMSTUDIO_MODELS } from './defs';
import { Tool } from './tools';

// TODO(dmaretskyi): Rename `ModelName`.
export const LLMModel = Schema.Literal(...DEFAULT_EDGE_MODELS, ...DEFAULT_OLLAMA_MODELS, ...DEFAULT_LMSTUDIO_MODELS);
