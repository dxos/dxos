...
export class WrappableError extends Error {
  trace?: Error;
  constructor(errorDescription: string, message?: string, innerError?: Error) {
...
export class ConnectionResetError extends WrappableError {
  constructor(message?: string, innerError?: Error) {
    super('connection reset', message, innerError);
  }
}

export class TimeoutError extends WrappableError {
  constructor(message?: string, innerError?: Error) {
    super('connection timeout', message, innerError);
  }
}

// general connectivity errors
export class ConnectivityError extends WrappableError {
  constructor(message?: string, innerError?: Error) {
    super('connectivity error', message, innerError);
  }
}

// TODO(nf): rename? the protocol isn't what's unknown...
export class UnknownProtocolError extends WrappableError {
  constructor(message?: string, innerError?: Error) {
