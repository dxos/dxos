...
export const UpdateSubscriptionRequest = Schema.Struct({
   ...
   */
  addIds: Schema.optional(Schema.mutable(Schema.Array(Schema.String))),
  /**
   * Automerge document ids to unsubscribe from.
   */
  removeIds: Schema.optional(Schema.mutable(Schema.Array(Schema.String))),
});
...
export const UpdateRequest = Schema.Struct({
  subscriptionId: Schema.String,
  updates: Schema.optional(Schema.mutable(Schema.Array(DocumentUpdate))),
});
...
export const FlushRequest = Schema.Struct({
   ...
   */
  documentIds: Schema.optional(Schema.mutable(Schema.Array(Schema.String))),
});
...
export const Entry = Schema.Struct({
  documentId: Schema.String,
  heads: Schema.optional(Schema.mutable(Schema.Array(Schema.String))),
});
export interface Entry extends Schema.Schema.Type<typeof Entry> {}

export const DocHeadsList = Schema.Struct({
  entries: Schema.optional(Schema.mutable(Schema.Array(Entry))),
});
