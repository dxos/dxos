...
export const CreateEpochResponse = Schema.Struct({
  /**
   * Credential of the new epoch.
   */
  epochCredential: Schema.optional(protoMessage('dxos.halo.credentials.Credential')),
  /**
