...
export const getObjectTemplateInputSchema = (template: unknown): S.Schema.AnyNoContext => {
  const inputs: Record<string, S.Schema.AnyNoContext> = {};
