...
subgraph core [core]
  ...
  subgraph mesh [mesh]
    ...
    dxos/websocket-rpc("@dxos/websocket-rpc"):::root
    click dxos/websocket-rpc "dxos/dxos/tree/main/packages/core/mesh/websocket-rpc/docs"
