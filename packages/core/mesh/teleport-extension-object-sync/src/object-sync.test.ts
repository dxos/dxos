...
describe('ObjectSync', () => {
  test('two peers synchronize an object', async () => {
    ...
    const peer1ObjectSync = peer1.teleport!.addExtension('dxos.mesh.teleport.objectsync', objectSync1.createExtension());
    ...
    const peer2ObjectSync = peer2.teleport!.addExtension('dxos.mesh.teleport.objectsync', objectSync2.createExtension());
