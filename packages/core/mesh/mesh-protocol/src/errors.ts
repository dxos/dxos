...
export const ERR_PROTOCOL_EXTENSION_MISSING = nanoerror('ERR_PROTOCOL_EXTENSION_MISSING', 'extension missing: %s');

export const ERR_EXTENSION_INIT_FAILED = nanoerror('ERR_EXTENSION_INIT_FAILED', 'extension init failed: %s');
export const ERR_EXTENSION_HANDSHAKE_FAILED = nanoerror(
  'ERR_EXTENSION_HANDSHAKE_FAILED',
  'extension handshake failed: %s'
);
export const ERR_EXTENSION_FEED_FAILED = nanoerror('ERR_EXTENSION_FEED_FAILED', 'extension feed failed: %s');
