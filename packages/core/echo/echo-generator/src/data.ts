...
const testSchemas = (): TestSchemaMap<TestSchemaType> => {
  ...
  }).pipe(Type.object(DXN.fromNsidAndVersion(TestSchemaType.document, '0.1.0')));
  ...
  }).pipe(Type.object(DXN.fromNsidAndVersion(TestSchemaType.organization, '0.1.0')));
  ...
  }).pipe(Type.object(DXN.fromNsidAndVersion(TestSchemaType.contact, '0.1.0')));
  ...
  const project = Schema.Struct({
    ...
    org: Schema.optional(Ref.Ref(organization)),
  }).pipe(Type.object(DXN.fromNsidAndVersion(TestSchemaType.project, '0.1.0')));
