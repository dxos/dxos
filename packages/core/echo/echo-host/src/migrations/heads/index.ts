...
/**
 * Automerge heads migrations, keyed `<id>_<name>` as `Migrator.fromRecord` expects. Ids must only ever increase,
...
export const MIGRATIONS_TABLE = 'automerge_heads_migrations';
