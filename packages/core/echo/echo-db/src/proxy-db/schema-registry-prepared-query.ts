...
const resultToEntry = <T extends Type.AnyType>(result: T): QueryResult.Entry<T> => ({
 ...
 */
export class SchemaRegistryPreparedQueryImpl<T extends Type.AnyType> implements QueryResult.QueryResult<T> {
