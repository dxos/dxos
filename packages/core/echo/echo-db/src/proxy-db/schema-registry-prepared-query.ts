...
const resultToEntry = <T extends Type.Entity>(result: T): QueryResult.Entry<T> => ({
 ...
 */
export class SchemaRegistryPreparedQueryImpl<T extends Type.Entity> implements QueryResult.QueryResult<T> {
