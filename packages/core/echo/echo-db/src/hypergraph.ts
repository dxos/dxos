...
export class Hypergraph {
   ...
   */
  private readonly spaceIdSpaceKeyMapping = new ComplexMap<PublicKey, SpaceId>(PublicKey.hash);
  ...
  _register(
    ...
    this.spaceIdSpaceKeyMapping.set(spaceKey, spaceId);
  ...
  _lookupLink(
    ...
    const spaceId = this.spaceIdSpaceKeyMapping.get(spaceKey);
