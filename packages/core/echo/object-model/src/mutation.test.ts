...
describe('Mutations', function () {
  ...
  test('ValueUtil.applyValue object', function () {
    const object = {
      version: '0.0.1',
      packages: {
        foo: 1,
