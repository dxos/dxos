...
import retireReverseRef2Cursors from './0004_retire_reverse_ref2_cursors.sql?raw';
...
export const MIGRATIONS = {
  ...
  '0004_retire_reverse_ref2_cursors': SqlMigrations.apply(retireReverseRef2Cursors),
};
