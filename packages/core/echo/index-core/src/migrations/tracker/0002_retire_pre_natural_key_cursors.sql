--
-- Retire the cursor names used before `objectMeta.naturalKey` existed. Renaming an index is the
-- invalidation mechanism: rows indexed under the old names hold NULL where a natural key may exist
