...
describe('IndexEngine', () => {
  ...
  it.effect(
    ...
    Effect.fnUntraced(function* () {
      ...
      const ftsResults1 = yield* ftsIndex.query({ query: 'Hello', spaceId: null, includeAllQueues: false, queueIds: null });
      ...
      const ftsResults2 = yield* ftsIndex.query({ query: 'World', spaceId: null, includeAllQueues: false, queueIds: null });
  ...
  it.effect(
    ...
    Effect.fnUntraced(function* () {
      ...
      const ftsResults = yield* ftsIndex.query({ query: 'TypeA', spaceId: null, includeAllQueues: false, queueIds: null });
