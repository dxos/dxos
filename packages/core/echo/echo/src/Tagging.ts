 ...
 * mutable and immutable objects and its label is resolved (and edited) in one place.
 */
...
/** Returns the tag ids applied to an object. */
...
/** Applies a tag to an object (idempotent). */
...
/** Removes a tag from an object. No-op when not present. */
