...
export const CustomAnnotations: Partial<Record<RootJsonSchemaProperty, string>> = {
 ...
 */
export const DecodedAnnotations: Partial<Record<RootJsonSchemaProperty, string>> = {
