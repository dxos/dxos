...
describe('Obj.setValue', () => {
  ...
  test('sets multiple nested array elements', ({ expect }) => {
    ...
    }).pipe(Type.object(DXN.fromNsidAndVersion('com.test.type.container', '0.1.0')));
  ...
  test('handles two-dimensional arrays', ({ expect }) => {
    ...
    }).pipe(Type.object(DXN.fromNsidAndVersion('com.test.type.matrix', '0.1.0')));
  ...
  test('handles array with object with required field', ({ expect }) => {
    ...
    }).pipe(Type.object(DXN.fromNsidAndVersion('com.test.type.todoList', '0.1.0')));
