...
export const instanceOf: {
  <S extends Type.Obj.Any>(schema: S): (value: unknown) => value is Schema.Schema.Type<S>;
  <S extends Type.Obj.Any>(schema: S, value: unknown): value is Schema.Schema.Type<S>;
} = ((...args: [schema: Type.Obj.Any, value: unknown] | [schema: Type.Obj.Any]) => {
  if (args.length === 1) {
...
export const getDXN = (entity: Any): DXN => {
