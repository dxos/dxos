...
export interface Registry {
   ...
   * and boolean combinators. Full-text filters evaluate in memory (case-insensitive all-terms
   * containment over the entity's serialized strings). Server-side concerns (order, traversal,
   * vector search, timestamp filters) throw or match nothing.
   */
