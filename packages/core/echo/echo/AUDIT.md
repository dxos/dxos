...
| ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- | ------------------------------------------------------------------------------------------------------ |
| [plugin-magazine/curate-magazine.ts](packages/plugins/plugin-magazine/src/operations/curate-magazine.ts)                 | `queue.queryObjects()`              | `Feed.runQuery` Effect with per-call layer                                                             |
| [plugin-magazine/sync-feed.ts](packages/plugins/plugin-magazine/src/operations/sync-feed.ts)                             | `queue.append(items)`               | `Feed.append` Effect                                                                                   |
