...
const STOP_WORDS = new Set([
  'about', 'after', 'again', 'also', 'because', 'been', 'before', 'being', 'between', 'both',
  'cannot', 'could', 'does', 'doing', 'down', 'each', 'from', 'have', 'having', 'here', 'idea',
  'into', 'just', 'like', 'looks', 'made', 'make', 'makes', 'maybe', 'more', 'most', 'much', 'need',
  'only', 'other', 'over', 'please', 'probably', 'really', 'right', 'same', 'should', 'some',
  'something', 'sure', 'thanks', 'that', 'them', 'then', 'there', 'these', 'they', 'thing', 'think',
  'this', 'those', 'want', 'well', 'were', 'what', 'when', 'where', 'which', 'will', 'with', 'would',
  'yeah', 'your',
]);
