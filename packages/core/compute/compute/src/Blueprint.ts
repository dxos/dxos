...
import { DXN, Annotation, Database, Filter, Migration, Obj, Registry, Type, URI, Ref } from '@dxos/echo';
...
export const Blueprint = Schema.Struct({
  ...
  /**
   * Hooks are triggerd automatically at certain points in the agent's lifecycle.
   */
...
export const HookSpec = Schema.Union(
  /**
   * Tiggered when the agent is about to start a request.
   * A request is a series of agent/tool turns that the model drives.
   */
  Schema.TaggedStruct('begin-request', {}),
  /**
   * Tiggered when the agent has completed a request.
   * A request is a series of agent/tool turns that the model drives.
   */
...
/**
 * Allows to hook into the agent's lifecycle.
