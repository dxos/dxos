  ...
  it.effect(
    ...
    agentTest({
      instructions: trim`
        ...
        Call the ReadEmail operation (org.dxos.operation.inbox.readEmail) for that mailbox. With no messages in the feed, it should return zero emails — the important part is that ReadEmail completes successfully, not the count.
      `,
      completionCriteria: [
