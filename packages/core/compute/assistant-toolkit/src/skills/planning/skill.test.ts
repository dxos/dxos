...
describe('Planning skill', () => {
  ...
  // HarnessService Tier B (like the alarm skill's set-alarm) to enqueue a reminder. Spawning a
...
/**
 * Creates an agent (with the planning skill and a seeded plan) bound to its chat feed, then
