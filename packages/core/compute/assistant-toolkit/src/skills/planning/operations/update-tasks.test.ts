...
const TestLayer = AssistantTestLayer({
  ...
  types: [Agent.Agent, Outline.Outline, TaskSet.TaskSet, Task.Task, Text.Text, Chat.Chat, Skill.Skill, Feed.Feed],
  ...
  it.effect(
    ...
    Effect.fnUntraced(
      function* ({ expect }) {
        ...
        expect(chat.taskSet).toBeDefined();
