...
// Shared implementation of the mutually-referencing Agent + Chat pair (an import cycle if split);
// consumed only through the `./Agent` and `./Chat` namespace facades.
...
//
// Agent — co-located with Chat (see module comment).
//
