      ...
      switch (invitation.state) {
        ...
        case Invitation_State.SUCCESS: {
          dispatch({
            ...
            status: invitation.state,
            result: {
              spaceKey: invitation.spaceKey ? PublicKey.from(invitation.spaceKey.data) : null,
              identityKey: invitation.identityKey ? PublicKey.from(invitation.identityKey.data) : null,
              swarmKey: invitation.swarmKey ? PublicKey.from(invitation.swarmKey.data) : null,
