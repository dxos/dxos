...
export type CreateTypeExtensionOptions<
  T extends Type.AnyObjectType | Type.AnyRelationType = Type.AnyObjectType | Type.AnyRelationType,
  R = never,
> = {
  id: string;
  type: T;
 ...
 * Returns an Effect to allow callbacks to access services via dependency injection.
 */
export const createTypeExtension = <T extends Type.AnyObjectType | Type.AnyRelationType, R = never>(
