 ...
 *
 * TODO(wittjosiah): Remove? Callers now expand the nodes they need explicitly; the once-per-id latch is
 * incompatible with re-running an expansion (as URL resolution does while a chain materializes).
 */
