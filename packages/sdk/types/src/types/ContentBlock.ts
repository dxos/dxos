...
export type Base = Type.InstanceType<typeof Base>;
/**
...
export type Reasoning = Type.InstanceType<typeof Reasoning>;
/**
...
export type ToolCall = Type.InstanceType<typeof ToolCall>;
...
export type ToolResult = Type.InstanceType<typeof ToolResult>;
/**
 * GPT Summary
 */
...
export type Stats = Type.InstanceType<typeof Stats>;
/**
 * Claude-like message
...
export type Image = Type.InstanceType<typeof Image>;
/**
 * File
 */
...
export type Reference = Type.InstanceType<typeof Reference>;
/**
 * Transcript block.
 */
...
export type Status = Type.InstanceType<typeof Status>;
/**
...
export type Suggestion = Type.InstanceType<typeof Suggestion>;
/**
...
export type Select = Type.InstanceType<typeof Select>;
/**
...
export type Anchor = Type.InstanceType<typeof Anchor>;
/**
...
export type Proposal = Type.InstanceType<typeof Proposal>;
/**
...
export type Summary = Type.InstanceType<typeof Summary>;
/**
...
export type Toolkit = Type.InstanceType<typeof Toolkit>;
/**
 * JSON
...
export type Json = Type.InstanceType<typeof Json>;
