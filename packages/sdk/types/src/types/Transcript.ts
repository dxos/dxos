...
import { EchoId, type LegacyDXN } from '@dxos/keys';
...
export const make = (queueDxn: LegacyDXN | EchoId.EchoId): Transcript => Obj.make(Transcript, { queue: Ref.fromDXN(queueDxn) });
