...
// NOTE: `AiObservability` is deliberately absent, unlike the namespaces below — it is a standalone
// entrypoint at `@dxos/observability/AiObservability`. Composer's boot imports this barrel, and the
