...
/** Producer-side handle posting span records to the worker (see the extension's `logWriter`). */
 ...
 * runs in the log-writer worker. Sampling, ID generation, and context propagation stay in
