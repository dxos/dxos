...
export const translations = [
  {
    'en-US': {
      [translationKey]: {
        ...
        'reset-storage-input.label': 'Type {{confirmationValue}} to confirm.',
        'join-new-identity.label': 'Join an existing identity',
        'join-new-identity-input.label': 'Type {{confirmationValue}} to confirm.',
        'failed-to-reset-identity.message': 'Failed to reset identity.',
        'confirmation.value': 'RESET',
        'confirmation.placeholder': 'Type {{confirmationValue}} to confirm.',
        'sign-out-chooser.title': 'WARNING',
        'sign-out-chooser.message':
          'Proceeding with the action below will erase all data on this device. This action cannot be undone.',
