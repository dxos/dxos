...
export const BifurcatedAction = forwardRef<
	HTMLButtonElement,
	BifurcatedActionProps
>((props, forwardedRef) => {
	const {
		classNames,
		variant,
	...
	const [activeActionKey = Object.keys(actions)[0], setActiveAction] =
	...
	return (
		<div
			role="none"
			className={mx("mbs-2 flex gap-px items-center", isFull && "is-full")}
		>
			<Button
				{...rest}
				classNames={[
...
export const Action = forwardRef<HTMLButtonElement, LargeButtonProps>(
	(props, forwardedRef) => {
