...
export const AgentConfig = ({
  ...
  return (
    <>
      ...
      {validationMessage && (
        <p role='alert' className={valenceColorText('error')}>
          {validationMessage}
        </p>
      )}
      {agentStatus === 'online' ||
      ...
      agentStatus === 'destroying' ? (
        <div role='group' className='mlb-2 flex gap-2 items-center'>
          <Avatar.Root status={agentStatus === 'online' ? 'active' : 'inactive'} variant='square'>
