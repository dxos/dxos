 ...
 * a "Download logs" action next to the theme-independent default `ErrorFallback`'s "Copy" button,
 * so a crashed story still offers a one-click way to grab the story's buffered logs, matching the
 * manager toolbar's button (see `@dxos/storybook-addon-logger`).
 *
