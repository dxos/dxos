...
export namespace Capabilities {
	 ...
	 * @category Capability
	 */
	export const Null = defineCapability<null>(
		"dxos.org/app-framework/capability/null",
	);

	/**
	 * @category Capability
	 */
	export const PluginManager = defineCapability<PluginManager>(
	 ...
	 * @category Capability
	 */
	export const RxRegistry = defineCapability<Registry.Registry>(
		"dxos.org/app-framework/capability/rx-registry",
	);
	 ...
	 * @category Capability
	 */
	export const ReactContext = defineCapability<ReactContext>(
		"dxos.org/app-framework/capability/react-context",
	);
	 ...
	 * @category Capability
	 */
	export const ReactRoot = defineCapability<ReactRoot>(
		"dxos.org/app-framework/capability/react-root",
	);
	 ...
	 * @category Capability
	 */
	export const ReactSurface = defineCapability<ReactSurface>(
	 ...
	 * @category Capability
	 */
	export const IntentResolver = defineCapability<IntentResolver>(
		"dxos.org/app-framework/capability/intent-resolver",
	);
	 ...
	 * @category Capability
	 */
	export const Layout = defineCapability<Layout>(
		"dxos.org/app-framework/capability/layout",
	);
	...
	export const Translations = defineCapability<Readonly<Resource[]>>(
		"dxos.org/app-framework/capability/translations",
	);

	/**
	 * @category Capability
	 */
	export const AppGraph = defineCapability<
		Readonly<Pick<GraphBuilder, "graph" | "explore">>
	...
	export const SettingsStore = defineCapability<RootSettingsStore>(
		"dxos.org/app-framework/capability/settings-store",
	);
	 ...
	 * @category Capability
	 */
	export const Settings = defineCapability<Settings>(
		"dxos.org/app-framework/capability/settings",
	);
	 ...
	 * @category Capability
	 */
	export const Metadata = defineCapability<Metadata>(
		"dxos.org/app-framework/capability/metadata",
	);
	 ...
	 * @category Capability
	 */
	export const Toolkit = defineCapability<Toolkit.Any>(
	 ...
	 * @category Capability
	 */
	export const ToolkitHandler = defineCapability<
		Layer.Layer<Tool.Handler<any>, never, never>
	 ...
	 */
	export const AiModelResolver = defineCapability<
		Layer.Layer<AiServiceRouter.AiModelResolver>
	 ...
	 * @category Capability
	 */
	export const FileUploader = defineCapability<FileUploader>(
		"dxos.org/app-framework/capability/file-uploader",
	);

	type AnchorSort = {
		key: string;
		sort: (
			anchorA: DataType.AnchoredTo.AnchoredTo,
			anchorB: DataType.AnchoredTo.AnchoredTo,
		) => number;
	};
	 ...
	 * @category Capability
	 */
	export const AnchorSort = defineCapability<AnchorSort>(
		"dxos.org/app-framework/capability/anchor-sort",
	);
}
