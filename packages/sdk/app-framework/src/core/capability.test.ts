...
describe('Capability tags', () => {
  it('singleton tags are yieldable Effect services', () => {
    const tag = Capability.make<Example>('@dxos/app-framework/test/example');
  ...
  it.effect('multi tags yield a live contributions view', () =>
    Effect.gen(function* () {
      ...
      const multi = Capability.makeMulti<Example>('@dxos/app-framework/test/example');
  ...
  it('tags remain assignable to the legacy InterfaceDef', () => {
    const single = Capability.make<Example>('@dxos/app-framework/test/single');
    const multi = Capability.makeMulti<Example>('@dxos/app-framework/test/multi');
  ...
  describe('type-level enforcement', () => {
    it('EnsureProvides accepts complete returns and rejects missing capabilities', () => {
      const a = Capability.make<Example>('@dxos/app-framework/test/a');
      const b = Capability.makeMulti<Example>('@dxos/app-framework/test/b');
    ...
    it('Requirements exposes the identifiers of the declared requires', () => {
      ...
      const undeclared = Capability.make<Example>('@dxos/app-framework/test/undeclared');
