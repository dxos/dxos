...
// `LocalClientServices` is deliberately not re-exported from the package root (`@dxos/client/local`
// keeps the in-process service host, and everything it statically pulls in — echo-host,
// network-manager, teleport, sqlite, hypercore — out of every main-thread bundle's eager graph).
