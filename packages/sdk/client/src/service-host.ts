...
const serviceBundle = createServiceBundle<ClientServices>({
...
export class LocalClientServiceHost implements ClientServiceHost {
  ...
  services: ClientServices = {
    ProfileService: {
      SubscribeProfile: () => { throw new Error('Not implemented') },
      CreateProfile: () => { throw new Error('Not implemented') },
      RecoverProfile: () => { throw new Error('Not implemented') },
      CreateHALOInvitation: () => { throw new Error('Not implemented') },
      JoinHALO: () => { throw new Error('Not implemented') },
      SubmitInvitationSecret: () => { throw new Error('Not implemented') },
      SubscribeContacts: () => { throw new Error('Not implemented') },
      Reset: () => { throw new Error('Not implemented') },
    },
    PartyService: {
      SubscribeParties: () => { throw new Error('Not implemented') },
      CreateParty: () => { throw new Error('Not implemented') },
      CreateInvitation: () => { throw new Error('Not implemented') },
      JoinParty: () => { throw new Error('Not implemented') },
      SubmitInvitationSecret: () => { throw new Error('Not implemented') },
    },
