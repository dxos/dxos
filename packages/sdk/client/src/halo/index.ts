...
export { DeviceKind } from '@dxos/protocols/buf/dxos/client/services_pb';
export { type Contact, Device, type Identity } from '@dxos/protocols/buf/dxos/client/services_pb';
