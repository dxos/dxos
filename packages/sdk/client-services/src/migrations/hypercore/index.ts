...
/**
 * Hypercore file-storage migrations, keyed `<id>_<name>` as `Migrator.fromRecord` expects. Ids must only ever increase,
...
export const MIGRATIONS_TABLE = 'hypercore_files_migrations';
