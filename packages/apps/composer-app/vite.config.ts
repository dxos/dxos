  ...
  optimizeDeps: {
    ...
    entries: [
      ...
      isMinimalPluginSet
        ? path.resolve(
            rootDir,
            'packages/plugins/plugin-{assistant,attention,client,comments,debug,deck,graph,inbox,markdown,navtree,observability,onboarding,outliner,projects,registry,routine,settings,simple-layout,space,spotlight,status-bar,theme,thread}/src/index.{ts,tsx}',
          )
