  ...
  optimizeDeps: {
    ...
    entries: [
      ...
      isMinimalPluginSet
        ? path.resolve(
            rootDir,
            'packages/plugins/plugin-{assistant,attention,client,debug,deck,graph,inbox,markdown,navtree,review,observability,onboarding,registry,settings,simple-layout,space,spotlight,status-bar,theme,thread}/src/index.{ts,tsx}',
          )
