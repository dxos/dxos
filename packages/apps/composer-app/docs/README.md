...
subgraph apps [apps]
  ...
  subgraph patterns [patterns]
    ...
    dxos/react-ui-composer("@dxos/react-ui-composer"):::def
...
dxos/composer-app --> dxos/react-ui-composer
...
| [`@dxos/react-ui-composer`](../../patterns/react-ui-composer/docs/README.md) | &check; |
