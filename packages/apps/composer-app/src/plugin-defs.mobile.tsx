 ...
 * content), Projects and Transcription (voice input). Selection is build-time — swapping this file
 * in via `DX_PLUGIN_SET=mobile` — rather than a runtime flag, so a plugin with no mobile surface
...
/**
 * Plugin keys enabled by default for the mobile set — the same four plugins listed in
 * {@link getPlugins}.
 */
