...
import { Button, Dialog, DropdownMenu, Trans, useTranslation } from '@dxos/aurora';
...
import { ExportViewState, GhFileIdentifier, GhIdentifier, GhIssueIdentifier, MarkdownDocumentProps } from '../props';
import { EmbeddedLayout } from './EmbeddedLayout';
import { GfmPreview } from './GfmPreview';
import { StandaloneLayout } from './StandaloneLayout';
import { useTextFile } from './useTextFile';

export const MarkdownDocument = observer(
  ({ document, space, layout, editorViewState, setEditorViewState }: MarkdownDocumentProps) => {
    ...
    const handleGhImport = useCallback(() => {
      return (
        docGhId &&
        ('issueNumber' in docGhId ? importGhIssueContent() : 'path' in docGhId ? importGhFileContent() : null)
      );
