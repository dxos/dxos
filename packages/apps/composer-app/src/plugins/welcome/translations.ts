...
export const translations = [
  {
    'en-US': {
      [meta.id]: {
        ...
        'login-atmosphere.description': 'Recover your identity with your Atmosphere (atproto) account.',
        ...
        'or-divider.label': 'or',
        'atmosphere-account-button.label': 'Continue with an Atmosphere account',
