...
| --- | --- | --- | --- |
| Desktop app icon | `icon.svg` | `src-tauri/icons-<channel>` | `.github/actions/cn-config` |
| Favicons + manifest icons | `favicon.svg` | `favicons-<channel>/` | `src/vite/channel-branding.ts` |
