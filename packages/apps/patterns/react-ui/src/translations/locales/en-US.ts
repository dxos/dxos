...
export const os = {
  ...
  'joining space heading': 'Joining a space',
  ...
  'create identity label': 'Create a new identity',
  'create identity description': 'Create a new identity.',
  'recover identity label': 'Use a recovery phrase',
  'recover identity description': 'Enter your recovery phrase to log in manually.',
  ...
  'addition method selector title': 'Choose how to log in',
  'new identity input label': 'Choose a display name',
  'recover identity input label': 'Type or paste your recovery phrase',
  'failed to create identity message': 'Failed to create an identity.',
  'failed to recover identity message': 'Failed to recover an identity from the provided recovery phrase.',
