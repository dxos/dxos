  ...
  return (
    <div className="dxos flex justify-center align-middle">
      <div className="max-w-md bg-zinc-100 dark:bg-zinc-800 p-6 m-8 rounded-md shadow-lg">
        ...
        <p>
          Add your <code>css</code> to <code>src/index.css</code> or import{" "}
          <code>.css</code> files from your <code>.ts</code> files directly.
        </p>
        <p>
          When you are ready you can deploy this app to your{" "}
          <a
            href="https://docs.dxos.org/guide/kube"
            target="_blank"
            rel="noreferrer"
          >
            KUBE
        ...
        <ul>
          <li>
            <a
              href="https://docs.dxos.org/guide/react"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://docs.dxos.org/guide/kube/dx-yml-file"
              target="_blank"
              rel="noreferrer"
            >
              Deploying to KUBE
