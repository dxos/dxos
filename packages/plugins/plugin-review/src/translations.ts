...
export const translations = [
  {
    'en-US': {
      [meta.profile.key]: {
        ...
        'suggestion-authors.label': 'Suggestion authors',
        'show-author-suggestions.label': 'Show suggestions from {{author}}',
        'hide-author-suggestions.label': 'Hide suggestions from {{author}}',
