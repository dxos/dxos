...
- 6d28380: Remove the duplicate frame around the Quick Access panel: the dialog inside it no longer draws its own border, corner radius and shadow on top of the native panel frame.
