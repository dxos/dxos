...
export const SpringBlend: SpaceTemplate.Phase<SpringBlendResult, PersonMap> = SpaceTemplate.phase('springBlend', {
  ...
  run: (people: PersonMap) =>
    Effect.gen(function* () {
      ...
      yield* SpaceTemplate.children(taskSet, milestones, (taskSet, refs) => {
