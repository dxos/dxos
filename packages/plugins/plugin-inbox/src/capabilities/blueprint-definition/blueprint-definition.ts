...
const blueprintDefinition = Capability.makeModule<[], BlueprintCapabilities>(() =>
  Effect.succeed([
    ...
    Capability.contributes(Common.Capability.Functions, InboxSendBlueprint.functions),
    Capability.contributes(Common.Capability.BlueprintDefinition, InboxSendBlueprint.make()),
