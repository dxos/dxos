...
export const translations = [
  {
    'en-US': {
      ...
      [meta.profile.key]: {
        ...
        'topic-suggestions.label': 'Topic Suggestions',
        'topic-suggestions.toolbar.title': 'Topic suggestions toolbar',
        'topic-suggestions.empty.message': 'No topic suggestions. Run "Analyze Topics" to generate some.',
