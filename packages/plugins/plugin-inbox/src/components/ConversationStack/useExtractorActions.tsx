 ...
 *
 * `extractors` and `invoker` are resolved by the container (components must not call capability hooks);
 * the container wraps this as a `getExtractActions` callback passed down to the message tiles.
 */
export const buildExtractActions = (
