...
export default defineConfig({
  entry: {
    ...
    IncidentTemplate: 'src/templates/incident/IncidentTemplate.ts',
    PipelineTemplate: 'src/templates/crm/PipelineTemplate.ts',
    StockfishTemplate: 'src/templates/stockfish/StockfishTemplate.ts',
    TidepoolTemplate: 'src/templates/tidepool/TidepoolTemplate.ts',
    WeatherTemplate: 'src/templates/weather/WeatherTemplate.ts',
    WorkerTemplate: 'src/templates/worker/WorkerTemplate.ts',
