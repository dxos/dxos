...
export const DefaultStory = <T extends Obj.Any>({ Component, createObject, image }: DefaultStoryProps<T>) => {
  ...
  return (
    <div className='block-full grid grid-rows-2 p-16 gap-16'>
      {roles.map((role, i) => (
        <div key={i} className='flex block-full justify-center overflow-hidden'>
          <div className='flex flex-col gap-4 inline-full items-center'>
