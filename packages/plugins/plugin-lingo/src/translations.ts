...
export const translations = [
  {
    'en-US': {
      ...
      [meta.profile.key]: {
        ...
        'add-phrase.label': 'Add phrase to deck',
        'analyze.label': 'Analyze text',
        'analyze-error.message': 'Failed to analyze the text.',
        'segment-paragraph.label': 'paragraph',
        'segment-sentence.label': 'sentence',
        'segment-clause.label': 'clause',
