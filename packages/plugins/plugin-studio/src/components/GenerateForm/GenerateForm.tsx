...
export type GenerateFormProps = {
  ...
  /** Called with the updated config on every edit (the form auto-saves). */
 ...
 * surface.
 */
export const GenerateForm = ({ schema, value, onChange }: GenerateFormProps) => {
  ...
  return (
    <Form.Root schema={schema} values={value} autoSave onValuesChanged={handleValuesChanged}>
      <Form.Content>
        <Form.FieldSet />
      </Form.Content>
    </Form.Root>
