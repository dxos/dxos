...
export const FilesSettings = ({ settings }: { settings: FilesSettingsProps }) => {
  ...
  return (
    <>
      ...
      <FormInput label={t('auto export interval label')}>
        <Input.TextInput
          type='number'
          min={1}
      ...
      <FormInput label={t('open local files label')}>
        <Input.Switch
