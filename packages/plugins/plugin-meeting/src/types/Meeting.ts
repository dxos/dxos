...
import { MeetingSettingsSchema, type MeetingSettingsProps } from './Settings';
...
export const Settings = MeetingSettingsSchema;

export type Settings = MeetingSettingsProps;
