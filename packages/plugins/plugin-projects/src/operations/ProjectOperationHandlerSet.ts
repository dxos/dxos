...
export const handlers = OperationHandlerSet.lazy([
  ...
  ProjectMcpOperation.ArtifactAdd.pipe(Operation.lazyHandler(() => import('./artifact-add'))),
  ProjectMcpOperation.ArtifactList.pipe(Operation.lazyHandler(() => import('./artifact-list'))),
