...
# Task delegation and execution (merged from `project-tasks`, 2026-09-13)

The delegation stream — supervisor → durable Task → sub-agent → fold-back — lived as its own
registry project (`project-tasks`, PRs #12752 #12784 #12787 #12839 #12847 #13077) until it was
folded in here; its design notes are [DELEGATION.md](DELEGATION.md).
