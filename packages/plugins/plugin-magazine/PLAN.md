...
- We will create a new MagazinePlugin to manage and display feeds incl. RSS, BlueSky and other open protocols.
...
- [x] Register `OperationHandler` capability with `MagazineOperationHandlerSet`.
