...
const OFFERS: BookingSearchType.FlightOffer[] = [
  {
    ...
    id: 'off_1',
    provider: 'stub',
    carrier: { name: 'Duffel Airways', iataCode: 'ZZ' },
    totalAmount: 1373.56,
    currency: 'USD',
    cabinClass: 'business',
    slices: [
  ...
  },
  {
    ...
    id: 'off_2',
    provider: 'stub',
    carrier: { name: 'Iberia', iataCode: 'IB' },
    totalAmount: 1375.42,
    currency: 'USD',
    cabinClass: 'business',
    slices: [
      { origin: { code: 'JFK', name: 'New York' }, destination: { code: 'CDG', name: 'Paris' }, flightNumber: 'IB200' },
    ],
  },
];
