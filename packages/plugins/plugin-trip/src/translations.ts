...
export const translations = [
  {
    'en-US': {
      ...
      [meta.profile.key]: {
        ...
        'trip.plan-from-calendar.label': 'Plan trip from calendar',
        'trip.plan-from-calendar-success.title': 'Created a trip from your calendar.',
        'trip.plan-from-calendar-error.title': 'Could not create a trip from the calendar.',
