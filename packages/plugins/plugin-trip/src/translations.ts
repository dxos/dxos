...
export const translations = [
  {
    'en-US': {
      ...
      [meta.id]: {
        ...
        'route.section.label': 'Driving route',
        'route.empty.message': 'Add cities to plan a driving route between them.',
        'route.add.placeholder': 'Add a city…',
        'route.add.label': 'Add city',
        'route.remove.label': 'Remove city',
        'route.up.label': 'Move up',
        'route.down.label': 'Move down',
        'route.planning.label': 'Planning route…',
        'route.totals.label': '{{legs}} legs · {{distance}} · {{duration}}',
        'route.error.message': 'Could not plan the route. Check the routing provider and try again.',
      },
    },
  },
