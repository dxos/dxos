  ...
  useEffect(() => {
    if (identity && space) {
      const t = setTimeout(async () => {
        ...
        space.db.add(Obj.make(AnchoredTo, { [RelationSourceId]: thread1, [RelationTargetId]: object }));
        space.db.add(Obj.make(AnchoredTo, { [RelationSourceId]: thread2, [RelationTargetId]: object }));
      });
