...
const getName = (doc: Markdown.Doc, anchor: string): string | undefined => {
  if (doc.content) {
 ...
 * Construct plugins.
 */
export const threads = (state: ThreadState, doc?: Markdown.Doc, dispatch?: PromiseIntentDispatcher): Extension => {
