...
const getName = (doc: Document.Document, anchor: string): string | undefined => {
  if (doc.content) {
 ...
 * Construct plugins.
 */
export const threads = (state: ThreadState, doc?: Document.Document, dispatch?: PromiseIntentDispatcher): Extension => {
