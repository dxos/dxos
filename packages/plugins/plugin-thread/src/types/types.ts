...
export namespace ThreadAction {
	export class onCreateSpace extends Schema.TaggedClass<onCreateSpace>()(
		`${meta.id}/action/on-space-created`,
		{
			input: Schema.Struct({
				space: SpaceSchema,
	...
	export class CreateChannel extends Schema.TaggedClass<CreateChannel>()(
		`${meta.id}/action/create-channel`,
		{
			input: Schema.Struct({
	...
	export class Delete extends Schema.TaggedClass<Delete>()(
		`${meta.id}/action/delete`,
		{
			input: Schema.Struct({
	...
	export class Select extends Schema.TaggedClass<Select>()(
		`${meta.id}/action/select`,
		{
			input: Schema.Struct({
	...
	export class ToggleResolved extends Schema.TaggedClass<ToggleResolved>()(
		`${meta.id}/action/toggle-resolved`,
		{
			input: Schema.Struct({
	...
	export class AddMessage extends Schema.TaggedClass<AddMessage>()(
		`${meta.id}/action/add-message`,
		{
			input: Schema.Struct({
				subject: EchoObjectSchema,
				anchor: DataType.AnchoredTo.AnchoredTo,
	...
	export class DeleteMessage extends Schema.TaggedClass<DeleteMessage>()(
		`${meta.id}/action/delete-message`,
		{
			input: Schema.Struct({
				anchor: DataType.AnchoredTo.AnchoredTo,
				subject: EchoObjectSchema,
...
export type ThreadSettingsProps = Schema.Schema.Type<
	typeof ThreadSettingsSchema
>;
