...
export const ThreadPlugin = definePlugin(meta, () => [
		...
		activate: () => [
			...
			contributes(Capabilities.Metadata, {
				...
				metadata: {
					...
					loadReferences: async (thread: Thread.Thread) =>
						await Ref.Array.loadAll(thread.messages ?? []),
				},
			}),
			contributes(Capabilities.Metadata, {
	...
	defineModule({
		...
		activate: () =>
			contributes(ClientCapabilities.Migration, [
				DataType.Message.MessageV1ToV2,
			]),
	}),
	defineModule({
