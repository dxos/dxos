...
const SAMPLE_GAME = {
  ...
  pgn: '[White "alice"]\n[Black "bob"]\n\n1. e4 e5 2. Nf3 Nc6 *',
  uuid: 'game-uuid-1',
  white: { rating: 600, result: 'win', '@id': 'https://api.chess.com/pub/player/alice', username: 'alice', uuid: 'w1' },
  black: { rating: 600, result: 'resigned', '@id': 'https://api.chess.com/pub/player/bob', username: 'bob', uuid: 'b1' },
};
