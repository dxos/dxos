...
const pluginTranslations = [
  {
    'en-US': {
      [meta.id]: {
        ...
        'account-loading.message': 'Loading…',
        'account-offline.message': 'Could not reach the server. Showing cached account information.',
        'email.label': 'Email',
        'role.label': 'Role',
        ...
        'no-invitations.title': 'No invitations issued yet.',
        'invitation-redeemed.label': 'redeemed',
        'invitation-available.label': 'available',
