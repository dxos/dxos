...
const pluginTranslations = [
  {
    'en-US': {
      [meta.id]: {
        ...
        'no edge access title': 'No access to edge services',
        'no edge access description':
          'This identity is not bound to a DXOS account. Some features may not work as expected. Request access to be notified when an invitation is available.',
        'access request email placeholder': 'you@example.com',
        'request access button': 'Request access',
        'access request submitted': 'Thanks — we’ll be in touch.',
        'account loading': 'Loading…',
        'account offline': 'Could not reach the server. Showing cached account information.',
        'email label': 'Email',
        'role label': 'Role',
        'invitations remaining label': 'Invitations remaining',
        'resend verification': 'Resend verification email',
        'verification email sent': 'Verification email sent.',
        'verification cooldown': 'Please wait {{seconds}}s before resending.',
        'verification not sent': 'Could not send verification email.',
        'generate invitation': 'Generate invitation',
        'no invitations issued': 'No invitations issued yet.',
        'invitation redeemed': 'redeemed',
        'invitation available': 'available',
