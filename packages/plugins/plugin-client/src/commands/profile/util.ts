 ...
 */
export const printProfileCreated = (name: string, path: string): Doc.Doc<any> =>
 ...
 */
export const printProfileDeleted = (name: string): Doc.Doc<any> =>
 ...
 */
export const printProfileReset = (profile: string): Doc.Doc<any> =>
 ...
 */
export const printProfile = (profile: ProfileInfo): Doc.Doc<any> => {
