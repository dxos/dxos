...
// A base document and two reviewers' proposals over it.
// Alice and Bob both rewrite "quick" (an overlap); each has one further, non-overlapping change.
...
export const AcceptReject: Story = {
  play: async ({ canvasElement }) => {
    ...
    // Accept the first card (offset then author ⇒ Alice's "quick"→"fast"):
    // the document takes "fast", Bob's overlapping "quick"→"swift" re-diffs against the new base and remains.
