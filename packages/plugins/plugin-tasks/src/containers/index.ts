...
export const RemoteSessionCard: ComponentType<any> = lazy(() => import('./RemoteSessionCard'));
export const QuickEntryDialog: ComponentType<any> = lazy(() => import('./QuickEntryDialog'));
export const TaskSetArticle: ComponentType<any> = lazy(() => import('./TaskSetArticle'));
