...
}).pipe(Operation.mcpTool({ name: 'outlineGet', safety: 'read', aspect: 'tasks', skill: CODE_PROJECT_SKILL_KEY }));
...
}).pipe(Operation.mcpTool({ name: 'outlineUpdate', safety: 'write', aspect: 'tasks', skill: CODE_PROJECT_SKILL_KEY }));
