...
export const translations = [
  {
    'en-US': {
      ...
      [Type.getTypename(Ibkr.Lot)]: {
        'typename.label': 'Lot',
        'typename.label_zero': 'Lots',
        'typename.label_one': 'Lot',
        'typename.label_other': 'Lots',
        'object-name.placeholder': 'Lot',
        'add-object.label': 'Lot',
        'rename-object.label': 'Rename lot',
        'delete-object.label': 'Delete lot',
        'object-deleted.label': 'Lot deleted',
      },
      [meta.profile.key]: {
