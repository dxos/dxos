...
const DefaultStory = (props: Omit<TokensPanelProps, 'integrations' | 'bareTokens' | 'spaceId'>) => {
  ...
  return <TokensPanel integrations={[]} bareTokens={tokens} spaceId={'space:test' as any} {...props} />;
};

const meta = {
  title: 'plugins/plugin-integration/components/TokensPanel',
  ...
  args: {
    ...
    onDeleteToken: (token: any) => console.log('onDeleteToken', token),
    onDeleteIntegration: (integration: any) => console.log('onDeleteIntegration', integration),
