...
export { CrmAppGraphBuilder as AppGraphBuilder } from './app-graph-builder.ts';

export { AutomationTemplates } from './automation-templates.ts';

export { MailboxAction } from './mailbox-action.ts';
...
export { SenderAction } from './sender-action.ts';
