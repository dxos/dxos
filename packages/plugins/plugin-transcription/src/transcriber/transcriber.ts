...
export type TranscriberParams = {
   ...
   */
  onSegments: (segments: Message.ContentBlock.Transcript[]) => Promise<void>;
};
...
export class Transcriber extends Resource {
  ...
  private _alignSegments(segments: WhisperSegment[], originalChunks: AudioChunk[]): Message.ContentBlock.Transcript[] {
