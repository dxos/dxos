...
const StreamingStory = ({ mode, initialBufferMs, wordIntervalMs, postProcess }: StoryArgs) => {
  ...
  return (
    <div className='flex flex-col gap-4 p-4 is-[40rem]'>
...
} satisfies Meta<typeof StreamingStory>;
...
export const WordByWord: Story = {
  args: { mode: 'word', initialBufferMs: 0, wordIntervalMs: 80, postProcess: true },
};

export const Batched: Story = {
  args: { mode: 'batch', initialBufferMs: 1000, wordIntervalMs: 80, postProcess: true },
};
