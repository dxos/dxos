...
export const transcriptBlocks: TranscriptBlock[] = [
  create(TranscriptBlock, {
    authorName: contacts.john.name,
    segments: [
      {
        started: getDate(0),
  ...
  create(TranscriptBlock, {
    authorName: contacts.sarah.name,
    segments: [
      {
        started: getDate(45),
  ...
  create(TranscriptBlock, {
    authorName: contacts.david.name,
    segments: [
      {
        started: getDate(120),
