...
export const translations = [
  {
    'en-US': {
      [meta.id]: {
        ...
        'select-new-plank-positioning.description': 'Choose whether newly opened planks appear at the start or end of the deck.',
        ...
        'settings-overscroll.description': 'Control how planks behave when scrolled to the edge of the deck.',
