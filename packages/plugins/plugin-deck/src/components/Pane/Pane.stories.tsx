...
// A self-contained main Pane that is its own attendable region (focusing it sets attention, which the
// sigil and title reflect via the accent color).
const MainPane = ({ id, label }: { id: string; label: string }) => {
...
const meta: Meta = {
  title: 'plugins/plugin-deck/components/Pane',
