  ...
  return (
    <header
      className={mx(
        ...
        variant === 'topbar' &&
          'fixed inset-inline-0 block-start-[env(safe-area-inset-top)] block-[--rail-size] border-be border-separator',
        classNames,
      )}
    >
      ...
      {variant === 'topbar' && (
        <div role='none' className='absolute inset-0 pointer-events-none'>
          <div role='none' className='grid block-full pointer-fine:p-1 max-is-md mx-auto pointer-events-auto'>
