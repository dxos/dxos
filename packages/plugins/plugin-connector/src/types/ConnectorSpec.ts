 ...
 * of the connection's bindings (see `syncConnectionBindings` for the shared fan-out).
 */
...
export type ConnectorSync = {
  /** Reconcile every binding of a connection with its remote (see `syncConnectionBindings`). */
