...
export const PipelineColumn = ({ data: column, location, classNames, debug }: PipelineColumnProps) => {
  ...
  const projectionModel = useMemo(() => {
    ...
    // TODO(wittjosiah): resolveSchemaWithRegistry returns Schema.Schema.AnyNoContext, not Type.AnyEntity,
    // so schema.jsonSchema is not available here. This branch can be simplified once
    // resolveSchemaWithRegistry is updated to return Type.AnyEntity directly.
