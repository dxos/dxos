...
export const translations = [
  {
    'en-US': {
      ...
      [meta.id]: {
        ...
        'space settings schema label': 'Records',
        'schema verbose label': 'Manage records',
        'schema description': 'You can manage all of the records stored within this space here.',
        'no schemas found message': 'No records found',
