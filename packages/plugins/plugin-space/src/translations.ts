...
export const translations = [
	{
		"en-US": {
			...
			[meta.id]: {
				...
				"confirm restore body":
					"Restoring from a backup will overwrite the contents of any documents that match.",
				...
				"waiting for object description":
					"The requested item is still being synchronized.",
				...
				"persisted locally message":
					"All changes have been saved to disk on this device.",
				...
				"remove deleted objects alt":
					"Permanently remove deleted items to free up space.",
				...
				"members description":
					"You can view the current status of space members here as well as invite new members.",
				"members label": "Members",
				"invitations label": "Invitations",
				"space invitation description": "Manage invitations to the space.",
				"qr code description":
					"Share this QR code, or copy the URL and share it with the person you want to invite.",
				"locked space description":
					"This space is locked, unlock it to invite new members.",
				"space locked label": "Lock space",
				"space locked description":
					"Locking a space prevents new members from being invited to the space.",
				...
				"space properties settings description":
					"You can configure how this space is displayed in the app here.",
				"space settings schema label": "Record types",
				"schema verbose label": "Manage record types",
				"schema description":
					"You can manage all of the record types stored within this space here.",
				"no schemas found message": "No record types found",
				"display name input placeholder": "Space name",
				"display name description":
					"Name of the space as it appears in the app.",
