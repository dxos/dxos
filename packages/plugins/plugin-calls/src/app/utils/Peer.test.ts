...
test('bulkRequest', async () => {
  const dispatcher: BulkRequestDispatcher<number, void> = new BulkRequestDispatcher();
...
test('bulkRequestWithLimit', async () => {
  const dispatcher: BulkRequestDispatcher<number, void> = new BulkRequestDispatcher(2);
