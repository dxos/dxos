...
export default async (originalVideoStreamTrack: MediaStreamTrack) => {
  ...
  const loaded = new Promise((res) => video.addEventListener('loadedmetadata', res, { once: true }));
