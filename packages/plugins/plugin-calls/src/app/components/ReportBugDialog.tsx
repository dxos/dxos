...
const ReportBugForm: FC<{}> = () => {
  ...
  return data ? (
    ...
    <div className='space-y-4'>
      ...
      <Description>The Calls team will be notified with tracing details.</Description>
      <details className='cursor-pointer'>
        <summary className='text-sm text-zinc-500 dark:text-zinc-400'>Debug Info (included automatically)</summary>
        <div className='space-y-4'>
