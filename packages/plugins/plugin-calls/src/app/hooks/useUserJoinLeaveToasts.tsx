...
const UserJoinedOrLeftToast = (props: { user: User; type: 'joined' | 'left' }) => {
  ...
  return (
    <div className='flex items-center justify-center gap-2 text-sm'>
      <Toast.Title>
        <OptionalLink
          href={
            props.user.transceiverSessionId ? populateTraceLink(props.user.transceiverSessionId, traceLink) : undefined
          }
          target='_blank'
...
export const useUserJoinLeaveToasts = (users: User[]) => {
