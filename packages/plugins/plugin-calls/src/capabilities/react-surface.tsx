    ...
    Capability.contributes(Capabilities.ReactSurface, [
      ...
      Surface.create({
        ...
        filter: AppSurface.predicate(
          AppSurface.Article,
          (data): data is CallRoomData =>
            typeof (data as Record<string, unknown>).subject === 'object' &&
            typeof ((data as Record<string, unknown>).subject as Record<string, unknown>).roomId === 'string',
        ),
