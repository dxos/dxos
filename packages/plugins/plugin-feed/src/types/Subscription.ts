...
export const SYSTEM_TAGS = {
  starred: { key: { source: 'org.dxos.plugin.feed', id: 'starred' }, label: 'Starred', hue: 'amber' },
  archived: { key: { source: 'org.dxos.plugin.feed', id: 'archived' }, label: 'Archived', hue: 'neutral' },
} as const;
