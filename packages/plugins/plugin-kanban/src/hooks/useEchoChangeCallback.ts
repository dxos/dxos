 ...
 */
export const createEchoChangeCallback = <T extends Obj.Unknown>(
  kanban: Kanban.Kanban,
): KanbanLayout.KanbanChangeCallback<T> => ({
...
): KanbanLayout.KanbanChangeCallback<T> | null =>
  useMemo(() => (kanban ? createEchoChangeCallback<T>(kanban) : null), [kanban]);
