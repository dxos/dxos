...
export default Capability.makeModule(
  Effect.fnUntraced(function* () {
    ...
    const stateAtom = Atom.make<FileSystemCapabilities.FileSystemState>({
      workspaces: [],
    ...
    return [
      Capability.contribute(FileSystemCapabilities.State, stateAtom),
      Capability.contribute(FileSystemCapabilities.FileSystemManager, fileSystemManager),
    ];
  }),
);
