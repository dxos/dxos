...
export const useNode = <T = any>(graph: Graph.ReadableGraph, id?: string): AppGraphNode.Node<T> | undefined => {
 ...
 */
export const useActions = (graph: Graph.ReadableGraph, id?: string): AppGraphNode.Node[] => {
