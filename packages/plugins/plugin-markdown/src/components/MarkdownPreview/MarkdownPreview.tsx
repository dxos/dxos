...
const getTitle = (subject: Markdown.Doc | DataType.Text, fallback: string) => {
  if (Obj.instanceOf(Markdown.Doc, subject)) {
...
// TODO(burdon): Factor out.
const getSnippet = (subject: Markdown.Doc | DataType.Text, fallback: string) => {
  if (Obj.instanceOf(Markdown.Doc, subject)) {
...
export const MarkdownPreview = ({ subject, role }: PreviewProps<Markdown.Doc | DataType.Text>) => {
