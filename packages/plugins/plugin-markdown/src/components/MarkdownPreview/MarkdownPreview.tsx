...
const getTitle = (subject: Document.Document | DataType.Text, fallback: string) => {
  if (Obj.instanceOf(Document.Document, subject)) {
...
// TODO(burdon): Factor out.
const getSnippet = (subject: Document.Document | DataType.Text, fallback: string) => {
  if (Obj.instanceOf(Document.Document, subject)) {
...
export const MarkdownPreview = ({ subject, role }: PreviewProps<Document.Document | DataType.Text>) => {
