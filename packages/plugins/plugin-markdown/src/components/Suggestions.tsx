...
import { automerge, command, translations as editorTranslations } from '@dxos/react-ui-editor';
...
const DefaultStory = () => {
  ...
  const extensions = useMemo(() => [automerge(createDocAccessor(doc, ['content'])), command()], [doc]);
