...
describe('diffSpans', () => {
  test('computes insert/delete/equal spans', () => {
  ...
  test('offsets index into the after text', () => {
...
describe('merge3', () => {
  ...
  test('applies identical hunks from both sides once', () => {
    const base = 'alpha\nbravo\n';
  ...
  test('marks conflicting hunks, preferring theirs first', () => {
    const base = 'alpha\nbravo\n';
  ...
  test('returns theirs when ours is unchanged from base', () => {
    const base = 'alpha\n';
    const theirs = 'alpha\nbeta\n';
    expect(merge3({ base, ours: base, theirs }).text).toBe(theirs);
  });

  test('returns ours when theirs is unchanged from base', () => {
    const base = 'alpha\n';
    const ours = 'alpha\nbeta\n';
    expect(merge3({ base, ours, theirs: base }).text).toBe(ours);
  });

  test('merges appends at end of file from one side', () => {
    const base = 'alpha\nbravo\n';
    const ours = 'alpha\nbravo\n';
    const theirs = 'alpha\nbravo\ncharlie\n';
    const result = merge3({ base, ours, theirs });
  ...
  test('merges from an empty base', () => {
  ...
  test('handles deletion on one side and edit elsewhere on the other', () => {
    const base = 'alpha\nbravo\ncharlie\n';
    const ours = 'alpha\ncharlie\n';
    const theirs = 'alpha\nbravo\ncharlie edited\n';
    const result = merge3({ base, ours, theirs });
  ...
  test('marks staggered overlapping hunks as a conflict', () => {
  ...
  test('staggered conflict regions include each side of the union', () => {
  ...
  test('adjacent hunks do not conflict', () => {
    const base = 'alpha\nbravo\n';
    const ours = 'alpha edited\nbravo\n';
    const theirs = 'alpha\nbravo edited\n';
    const result = merge3({ base, ours, theirs });
  ...
  test('preserves content without trailing newline', () => {
    const base = 'alpha';
    const ours = 'alpha';
