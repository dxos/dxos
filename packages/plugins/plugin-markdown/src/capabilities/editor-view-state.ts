...
import { type AspectDef, type ViewStateManager, defineViewState } from '@dxos/react-ui-attention';
 ...
 */
export const editorViewModeAspect: AspectDef<EditorViewMode | undefined> = defineViewState<EditorViewMode | undefined>({
