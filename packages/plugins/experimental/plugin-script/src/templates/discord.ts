...
// @ts-ignore
import { DiscordConfig, DiscordREST, DiscordRESTMemoryLive } from 'https://esm.sh/dfx@0.113.0?deps=effect@3.12.3';
// @ts-ignore
import { Effect, Config, Redacted, Ref } from 'https://esm.sh/effect@3.12.3';
