...
export const GridSheet = () => {
    ...
    (pos: DxGridPosition) => {
      switch (pos.plane) {
        case 'frozenRowsStart':
          return dxGrid.current?.setSelection({
  ...
  const { columns, rows } = useSheetModelDxGridProps(dxGrid.current, model);
  ...
  useUpdateFocusedCellOnThreadSelection(dxGrid.current);
