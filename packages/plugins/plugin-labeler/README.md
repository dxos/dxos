...
| ---------------------------------------- | ------------- | ------------------------------------------------- |
| Does this ask the recipient for a reply? | `probability` | `Needs reply` tag above the probability threshold |
...
The labels are the space's own user tags plus `none` — nothing is invented, and a low-confidence
answer applies nothing rather than a guess.
