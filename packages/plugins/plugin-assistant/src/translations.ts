  ...
  ...formTranslations,
  {
    'en-US': {
      ...
      [meta.profile.key]: {
        ...
        'trace-tag-space.label': 'Spaces',
        'trace-tag-identity.label': 'Identity',
        'trace-tag-sync.label': 'Sync',
        'trace-tag-agent.label': 'Agents',
        'trace-tag-automation.label': 'Automation',
        'trace-tag-tool.label': 'Agent tools',
        'trace-tag-system.label': 'System',
        'trace-tag-untagged.label': 'Untagged',
