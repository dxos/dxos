            ...
            <Popover.Viewport>
              <Tabs.Root orientation='horizontal' defaultValue='blueprints' defaultActivePart='list' tabIndex={-1}>
                ...
                >
                  ...
                  <Tabs.Tablist classNames='sm:overflow-x-hidden justify-center p-[--dx-cardChrome] border-y border-subdued-separator order-last'>
                    <Tabs.IconTab
                      value='blueprints'
...
const BlueprintsPanel = ({
  ...
  return (
    <SearchList.Root onSearch={handleSearch}>
      <SearchList.Content classNames='plb-cardChrome'>
        <SearchList.Viewport>
