        ...
        >
          {type !== 'collection' && (
            <div
              role='none'
              className={mx(
                'absolute -z-[1] group-hover/l0i:bg-cardSurface dx-focus-ring-group-indicator transition-colors',
                type === 'tab' || pinned ? 'rounded' : 'rounded-full',
                pinned ? 'bg-transparent inset-inline-3 inset-block-0' : 'bg-cardSurface inset-inline-3 inset-block-2',
              )}
            />
          )}
          <div
