...
import { Button, Icon, Input, List, ListItem, useTranslation } from '@dxos/react-ui';
        ...
        return (
          <Input.Root key={id} id={inputId}>
            ...
            >
              ...
              <div className='pbs-1'>
                <Input.Switch classNames='self-center' checked={isEnabled} onClick={() => onChange?.(id, !isEnabled)} />
              </div>
            </ListItem.Root>
          </Input.Root>
        );
