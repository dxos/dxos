...
// TODO(thure): There is debate about having to rename either the type or the React component.
//  A best practice should be chosen and either Board or Kanban (or both) should be refactored to apply it.
