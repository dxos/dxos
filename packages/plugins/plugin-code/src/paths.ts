...
export const getCodeProjectsPath = (spaceId: string): string => GraphPath.getSpacePath(spaceId, Segments.codeProjects);
...
export const getCodeProjectPath = (spaceId: string, projectId: string): string =>
  GraphPath.getSpacePath(spaceId, Segments.codeProjects, projectId);
