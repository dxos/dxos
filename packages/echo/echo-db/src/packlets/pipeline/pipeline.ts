import { FeedBlock, FeedStoreIterator } from "@dxos/echo-protocol";
...
export class Pipeline {
  ...
  private _iterator: FeedStoreIterator | undefined = undefined;
  ...
  createIterator(): AsyncIterable<FeedBlock> {
    this._iterator = new FeedStoreIterator(
      () => true,
