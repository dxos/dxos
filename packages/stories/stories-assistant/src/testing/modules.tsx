...
export const Module = {
  ...
  Document: Role.make<Record<string, any>>('org.dxos.storybook.module.document'),
...
export const moduleSurfaces: Surface.Definition[] = [
  ...
  Surface.create({
    id: 'module.document',
    filter: Surface.makeFilter(Module.Document),
    component: withModuleProps(DocumentModule),
  }),
  Surface.create({
  ...
  Surface.create({
    id: 'module.history',
    filter: Surface.makeFilter(Module.History),
    component: withModuleProps(HistoryModule),
  }),
  Surface.create({
    id: 'module.inbox',
