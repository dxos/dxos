...
import { Button, Panel, Tag, type ThemedClassName, Toolbar } from '@dxos/react-ui';
 ...
 */
export const SemanticFactsParser = ({ classNames, initialText = '', onParse }: SemanticFactsParserProps) => {
