...
describe('buildDraftPrompt', () => {
  test('applies the default instructions when none are given', () => {
  ...
  test('an explicit empty string opts out — base rules only', () => {
    const prompt = buildDraftPrompt('');
  ...
  test('a custom instruction overrides the default', () => {
