...
import { GitCommit, HardDrive, Queue, Rows, Bookmarks, Bookmark } from '@phosphor-icons/react';
        ...
        items: [
          {
            ...
            items: feedInfo.feeds?.map((feed) => ({
              ...
              Icon: Rows,
              Element: <TreeItemText primary={humanize(feed.feedKey)} secondary={bytes.format(feed.bytes)} />,
            })),
          },
          {
            id: 'snapshots',
