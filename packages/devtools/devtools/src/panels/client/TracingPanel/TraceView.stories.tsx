...
const state: State = {
  ...
  spans: new Map([
    [1, { id: 1, startTs: '0', endTs: '100', methodName: 'root1', resourceId: 1 } as any],
    [2, { id: 2, startTs: '50', endTs: '150', methodName: 'root2', resourceId: 2 } as any],
    [3, { id: 3, startTs: '10', endTs: '50', methodName: 'child1', parentId: 1, resourceId: 1 } as any],
    [4, { id: 4, startTs: '60', endTs: '120', methodName: 'child2', parentId: 2, resourceId: 2 } as any],
  ]),
};
