...
export const SwarmTable = ({ swarms, onClick }: SwarmListProps) => (
  <div className='flex flex-col grow h-screen is-full'>
    <div className='inline-flex is-full border-b border-slate-400 border-solid'>
    ...
    <div>
      {swarms.map((swarm) => (
        <div key={swarm.id.toHex()} className='inline-flex is-full border-b border-slate-200 border-solid'>
