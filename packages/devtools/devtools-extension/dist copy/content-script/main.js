(() => {
  ...
  import_crx_bridge.default.onMessage("extension.inject-client-script", () => {
    console.log("[DXOS devtools] Injecting client API...");
    const script = document.createElement("script");
    script.src = import_webextension_polyfill.default.runtime.getURL("content-script/init.js");
