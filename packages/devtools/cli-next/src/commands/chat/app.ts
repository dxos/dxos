...
import { type AiConversationRunParams, GenerationObserver } from '@dxos/assistant';
...
export class App {
  ...
  constructor(private _request: (params: AiConversationRunParams) => Promise<void>) {}
