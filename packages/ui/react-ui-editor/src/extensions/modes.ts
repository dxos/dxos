...
export const EditorViewModes = ['live-preview', 'read-only', 'source'] as const;
export type EditorViewMode = (typeof EditorViewModes)[number];
export type EditorInputMode = 'default' | 'vim' | 'vscode' | undefined;
...
export const EditorInputModes: { [mode: string]: Extension } = {
  default: [],
  vscode: [
