...
import { FieldScalarType, type ViewType } from '../types';
 ...
 */
export const FormEditor = <T = {},>({ classNames, view, schema, readonly }: FormEditorProps<T>) => {
  const handleAdd = () => {
    // TODO(burdon): Check unique.
    view.fields.push({ path: 'prop', type: FieldScalarType.String });
  };
