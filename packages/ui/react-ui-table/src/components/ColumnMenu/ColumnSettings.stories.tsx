...
const sampleTableDef: TableDef = {
  ...
  name: 'Sample Table',
  columns: [
    { id: 'col-1', prop: 'name', type: FieldKindEnum.String, label: 'Name' },
    { id: 'col-2', prop: 'age', type: FieldKindEnum.Number, label: 'Age', digits: 0 },
  ],
};
...
const sampleTablesToReference: TableDef[] = [
  sampleTableDef,
  {
    ...
    columns: [
      { id: 'ref-col-1', prop: 'id', type: FieldKindEnum.String, label: 'ID' },
      { id: 'ref-col-2', prop: 'description', type: FieldKindEnum.String, label: 'Description' },
    ],
  },
];
