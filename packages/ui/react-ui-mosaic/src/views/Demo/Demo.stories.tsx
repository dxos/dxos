...
export const Default = () => (
  <Mosaic.Root debug={debug}>
    ...
    <div className='flex grow overflow-hidden'>
      <div className='flex w-[280px] shrink-0 overflow-hidden'>
      ...
      <div className='flex w-[280px] shrink-0 overflow-hidden bg-neutral-900'>
...
export const Kanban = () => (
  <Mosaic.Root debug={debug}>
    ...
    <div className='flex grow overflow-hidden'>
      ...
      <div className='flex w-[280px] shrink-0 overflow-hidden bg-neutral-900 pl-2'>
