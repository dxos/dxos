...
const DefaultStory = () => {
  return (
    <Accordion.Root<TestItem> items={items} classNames='inline-[40rem]'>
      {({ items }) => (
        <div className='flex flex-col inline-full border-y border-separator divide-y divide-separator'>
          {items.map((item) => (
