...
import { Icon, type ThemedClassName, composable, composableProps, useTranslation } from '@dxos/react-ui';
 ...
 */
export const Empty = composable<HTMLDivElement, Pick<EmptyProps, 'label' | 'icon'>>(
  ({ label, icon, ...props }, forwardedRef) => {
