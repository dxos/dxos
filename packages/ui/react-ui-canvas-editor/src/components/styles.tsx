...
export const styles = {
  ...
  frameContainer: 'flex flex-column items-center box-border overflow-hidden bg-group-surface',
  frameBorder: 'border-2 border-hover-surface rounded-xs shadow-md',
  ...
  top: 'z-[100]',
  anchor: 'bg-base-surface border border-neutral-500 rounded-[50%] hover:bg-orange-500 cursor-crosshair',
  anchorActive: 'bg-orange-500',
  resizeBorder: 'border border-primary-500',
  resizeAnchor: 'bg-base-surface hover:bg-primary-300 dark:hover:bg-primary-700',
