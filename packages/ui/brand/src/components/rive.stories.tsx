...
const DefaultStory = () => {
  ...
  return (
    <>
      ...
      <div className='flex absolute left-0 right-0 top-[120px] block-[320px] align-center'>
        <div
          className='z-1 absolute inset-0 inline-[800px] m-auto'
          style={{
        ...
        <div
          className={mx(
            'z-2 absolute inset-0 flex items-center inline-[720px] m-auto p-2',
