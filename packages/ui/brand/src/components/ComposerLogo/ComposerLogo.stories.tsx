        ...
        <div>
          ...
          <div className={mx('transition opacity-0 duration-1000', logo && 'opacity-100')}>
            ...
            <div className={mx('flex items-center -mt-[20px] text-neutral-700')}>
              ...
              <div>
                <DXOS className='inline-[32px] block-[32px]' />
              </div>
            </div>
          </div>
        </div>
  ...
  render: () => {
    ...
    return (
      <div className='absolute inset-0 flex justify-center items-center'>
        <div className='grid grid-cols-3 gap-20 inline-[800px]'>
        ...
        <div className='flex flex-col'>
          <div className='flex items-center p-4'>
            <div className='flex ml-8 mr-[100px]'>
              <div>
                <Icon icon='ph--ghost--duotone' classNames='inline-[180px] block-[180px] text-blue-500' />
              </div>
              <div>
                <Icon icon='ph--ghost--duotone' classNames='inline-[180px] block-[180px] text-purple-500' />
              </div>
              <div>
                <Icon icon='ph--ghost--duotone' classNames='inline-[180px] block-[180px] text-red-500' />
              </div>
            </div>
            ...
            <div className='flex -ml-10'>
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className='p-4'>
                  <Icon icon='ph--square--duotone' classNames='inline-6 block-6 text-yellow-200' />
                </div>
              ))}
            </div>
          </div>
