...
const TabsTabGroupHeading = ({ children, classNames, ...props }: ThemedClassName<TabsTabGroupHeadingProps>) => {
  return (
    <h2 {...props} className={mx('my-1 px-2 text-sm text-unAccent', classNames)}>
      {children}
    </h2>
  );
};
  ...
  return (
    <TabsPrimitive.Trigger value={value} asChild>
      <Button
        ...
        onClick={handleClick}
        classNames={[
          orientation === 'vertical' && 'block justify-start text-start inline-full',
  ...
  return (
    <TabsPrimitive.Trigger value={value} asChild>
      <IconButton
        ...
        onClick={handleClick}
        classNames={[
          orientation === 'vertical' && 'justify-start text-start inline-full',
          orientation === 'vertical' && ghostSelectedContainerMd,
          classNames,
        ]}
      />
