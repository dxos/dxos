...
const DefaultStory = () => (
  <div className='mli-auto p-8 max-is-[60rem] space-b-4'>
    ...
    <h2 className='text-xl font-semibold'>
      Mọi <span className='font-mono'>Mọi</span> người đều có quyền nghỉ ngơi và giải trí, kể cả quyền được hạn chế hợp
      lý về số giờ làm việc và hưởng những ngày nghỉ định kỳ được trả lương.
    </h2>
