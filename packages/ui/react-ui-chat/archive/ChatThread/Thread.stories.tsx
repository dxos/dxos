...
import { Thread, type ThreadListProps } from './Thread';
import { translations } from '../../translations';

faker.seed(1);

const DefaultStory = ({ messages: _messages, ...props }: ThreadListProps) => {
...
const meta: Meta<ThreadListProps> = {
  title: 'ui/react-ui-chat/Thread',
  render: DefaultStory,
  component: Thread,
...
type Story = StoryObj<ThreadListProps>;
