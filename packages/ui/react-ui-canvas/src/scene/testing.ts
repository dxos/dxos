  ...
  switch (variant) {
    case 'flow':
      return builder
        ...
        .line(elementId('l1'), `${elementId('start')}#e`, `${elementId('work')}#w`)
        .line(elementId('l2'), `${elementId('work')}#e`, `${elementId('done')}#w`);
    case 'model':
      return builder
        .class(
          elementId('person'),
        ...
        .curve(elementId('works'), `${elementId('person')}#e`, `${elementId('org')}#w`);
    case 'cycle':
      return builder
