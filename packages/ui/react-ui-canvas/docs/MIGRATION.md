...
| Cut / copy / paste (ids not regenerated)                                                                                            | none                                                                                 | ✗      | M2: `clipboard` view atom of `{nodes, links}`; paste regenerates ids and offsets by one grid unit                       |
| Undo / redo                                                                                                                         | none (stubs upstream too)                                                            | ✗      | phase 2: per-view log of inverse intents                                                                                |
...
| Context menus                                                                                                                       | none upstream either                                                                 |        |                                                                                                                         |
