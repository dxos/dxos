...
/**
 * Transaction filter that strips characters matching the given pattern from inserted text.
 */
...
/**
 * Assembles the base editor setup: keymaps, history, bracket matching/closing, drop cursor,
 * read-only handling, line wrapping, and tab handling.
 */
...
/**
 * Wires document sync (automerge) and presence (awareness) for a text accessor.
 */
