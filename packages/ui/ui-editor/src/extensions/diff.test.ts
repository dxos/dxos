...
describe('diff hunks', () => {
  ...
  test('computeHunks finds changed regions', () => {
  ...
  test('cherryPickHunk applies the compare (A) version of the hunk overlapping the range', () => {
  ...
  test('reflects the latest compare text, not a snapshot', () => {
    const start = modified.indexOf('Line one');
  ...
  test('returns undefined when the range is not on a changed hunk', () => {
