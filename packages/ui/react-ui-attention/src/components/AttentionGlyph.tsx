...
const attentionGlyphStyles =
  'inline-block rounded-sm is-3 bs-3 bg-transparent fg-accent transition-colors [[data-attention=true]_&]:bg-bg-accent [[data-attention=true]_&]:fg-inverse [[aria-current][data-attention=true]_&]:bg-bg-accent [[aria-current][data-attention=true]_&]:fg-inverse';
