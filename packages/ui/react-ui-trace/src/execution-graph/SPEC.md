...
Source: `packages/ui/react-ui-trace/src/execution-graph/`.
...
From `packages/ui/react-ui-trace/src/components/Timeline/Timeline.tsx#L40`. The
builder sets:
...
| Symbol                                                  | File                                                                         | Line        |
| ------------------------------------------------------- | ---------------------------------------------------------------------------- | ----------- |
| `buildSpanTree`                                         | `packages/ui/react-ui-trace/src/execution-graph/span-tree.ts`                | L112        |
...
| `buildExecutionGraph`                                   | `packages/ui/react-ui-trace/src/execution-graph/execution-graph.ts`          | L91         |
