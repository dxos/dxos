...
const markers: GanttMarker[] = [
  ...
  { id: 'm:docs-start', laneId: 'docs', kind: 'operation', timestamp: T0 + 3 * MINUTE, label: 'Run Instructions' },
  { id: 'm:docs-tool', laneId: 'docs', kind: 'tool', timestamp: T0 + 4 * MINUTE, label: 'search' },
  {
    id: 'm:docs-fail',
    laneId: 'docs',
    kind: 'error',
  ...
  { id: 'm:notes-start', laneId: 'notes', kind: 'operation', timestamp: T0 + 4 * MINUTE, label: 'Run Instructions' },
