...
type FormContextValue<T extends Obj.Any> = FormHandler<T>;

const FormContext = createContext<FormContextValue<any> | undefined>(undefined);

export const useFormContext = <T extends Obj.Any>(): FormContextValue<T> => {
...
export const useFormValues = (path: (string | number)[] = []): any => {
  ...
  return getValue(formValues, jsonPath) as Obj.Any;
};
