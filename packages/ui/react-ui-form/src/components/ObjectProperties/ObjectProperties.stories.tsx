...
const Author = Schema.Struct({
  ...
  Type.object(DXN.fromNsidAndVersion('org.dxos.test.author', '0.1.0')),
...
const Article = Schema.Struct({
  ...
  Type.object(DXN.fromNsidAndVersion('org.dxos.test.article', '0.1.0')),
...
const Note = Schema.Struct({
  ...
  Type.object(DXN.fromNsidAndVersion('org.dxos.test.note', '0.1.0')),
  LabelAnnotation.set(['title']),
...
const Notebook = Schema.Struct({
  ...
  Type.object(DXN.fromNsidAndVersion('org.dxos.test.notebook', '0.1.0')),
  LabelAnnotation.set(['name']),
