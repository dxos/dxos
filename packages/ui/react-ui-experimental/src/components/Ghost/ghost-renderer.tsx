...
// The renderer, its hooks and config, kept out of `Ghost.tsx`: react-refresh only fast-refreshes a
// module whose exports are all components.
...
export const useGhost = (canvas: HTMLCanvasElement | null, props: Partial<GhostProps>): GhostRenderer | undefined => {
  const ghost = useMemo(() => {
