...
export const topbarBlockPaddingStart = 'py-(--dx-topbar-size) sticky-top-from-topbar-bottom';
export const bottombarBlockPaddingEnd = 'pb-(--dx-statusbar-size) sticky-bottom-from-statusbar-bottom';
