...
<<<<<<<< HEAD:packages/stories/stories-brain/src/components/types.ts
...
|||||||| fe6d829d76:packages/stories/stories-brain/src/components/util.tsx
export type EntityItem = {
  /** Entity id (slug) — the context key for filtering / graph rooting. */
  id: string;
  label: string;
...
========
>>>>>>>> claude/lucid-vaughan-efcdee:packages/ui/react-ui-fact-viewer/src/types.ts
/**
