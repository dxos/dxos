...
export class Analyzer {
  constructor(private readonly _results: PlanResults) {}
  ...
  async analyzeSwarmEvents() {
    ...
    return this._getStats(discoverLag, { failures });
  }

  private _getReader() {
    const reader = new LogReader();
    for (const { logFile } of Object.values(this._results.agents)) {
