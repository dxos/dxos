...
See [`../lang/core.mdl`](../lang/core.mdl) for the formal definition of the core
language and primitive types.
See [`../lang/examples/`](../lang/examples/) for the chess trilogy and the
spacetime plugin spec.
