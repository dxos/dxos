...
import { ChainPromptType, ChainType, MessageType, TextType, ThreadType } from '@braneframe/types';
...
export class TestProcessorBuilder {
  ...
  async init() {
    ...
    this._client.addTypes([TextType, MessageType, ThreadType, ChainPromptType, ChainType]);
