...
subgraph experimental [experimental]
  style experimental fill:#b3d3e6,stroke:#333
...
subgraph core [core]
  ...
  subgraph echo [echo]
    ...
    click dxos/echo-testing "dxos/dxos/tree/main/packages/core/echo/echo-testing/docs"
  end
end
...
| [`@dxos/echo-testing`](../../../core/echo/echo-testing/docs/README.md) | &check; |
...
| [`@dxos/react-client-testing`](../../../sdk/react-client-testing/docs/README.md) | &check; |
| [`@dxos/react-components`](../../../sdk/react-components/docs/README.md) | &check; |
| [`@dxos/react-echo-graph`](../../../sdk/react-echo-graph/docs/README.md) | &check; |
| [`@dxos/react-ipfs`](../../../sdk/react-ipfs/docs/README.md) | &check; |
