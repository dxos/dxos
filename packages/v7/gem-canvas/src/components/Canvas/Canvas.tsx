...
import { dragEllipse, drawEllipse } from '../../elements'; // TODO(burdon): Classes.
...
// TODO(burdon): Convert to classes.
...
export const Canvas = ({
  ...
  const elementCache = useMemo(() => new ElementCache(scale), [scale]);
