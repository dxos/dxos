...
import { CloseButton, FullScreen, OpenButton, SlidingAppBar, SlidingContent, SlidingDrawer, Toolbar } from '../src';
    ...
    <FullScreen sx={{ flexDirection: 'row' }}>
      ...
      <SlidingAppBar direction='right' drawerOpen={open} drawerWidth={width}>
        <Toolbar disableGutters variant='dense' sx={{ marginLeft: 2, marginRight: 1 }}>
          ...
          <Box sx={{ flex: 1 }} />
          {!open && <OpenButton direction='right' onOpen={() => setOpen(true)} />}
        </Toolbar>
      </SlidingAppBar>
      ...
      {/* Sidebar. */}
      <SlidingDrawer variant='persistent' direction='right' anchor='right' open={open} drawerWidth={width}>
        <Toolbar disableGutters variant='dense' sx={{ marginLeft: 1, marginRight: 1 }}>
