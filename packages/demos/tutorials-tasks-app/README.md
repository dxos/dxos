...
This project is meant to be a guideline for new developers to build an application with DXOS. Please, refer to our [Tutorial](https://dxos-docs.netlify.app/sdk/tutorial/introduction/) and follow the step-by-step guide to understand how it works.
...
By default, the tutorials-tasks-app uses a signal server deployed on a demo kube.
...
2. Use the signal server. Set the following code on the `config/config.yml` file on this project:
...
Below you will find the auto-generated documentation by CRA.
