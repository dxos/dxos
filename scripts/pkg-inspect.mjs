...
const argv = yargs(hideBin(process.argv))
  ...
  .example('$0 @effect/vitest --peer effect@3.12.3', 'Filter versions compatible with effect@3.12.3')
  .option('manifest', {
    type: 'boolean',
  ...
  .option('peer', {
    type: 'string',
    description: 'Filter versions compatible with the specified peer dependency (e.g., effect@3.12.3)',
  })
  .help().argv;
 ...
 * @param {string} peerOption - The peer option string (e.g., 'effect@3.12.3')
 * @returns {Object} - { name, version }
 */
