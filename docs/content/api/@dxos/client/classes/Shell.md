# Class `Shell`
<sub>Declared in [packages/sdk/client/src/services/shell.ts:46](https://github.com/dxos/dxos/blob/bfdd5a17b/packages/sdk/client/src/services/shell.ts#L46)</sub>


Interface for controlling the shell.

## Constructors
### [constructor(options)](https://github.com/dxos/dxos/blob/bfdd5a17b/packages/sdk/client/src/services/shell.ts#L52)
...
## Methods
### [initializeIdentity(options)](https://github.com/dxos/dxos/blob/bfdd5a17b/packages/sdk/client/src/services/shell.ts#L74)
...
### [joinSpace(options)](https://github.com/dxos/dxos/blob/bfdd5a17b/packages/sdk/client/src/services/shell.ts#L160)
...
### [open(layout, options)](https://github.com/dxos/dxos/blob/bfdd5a17b/packages/sdk/client/src/services/shell.ts#L62)
...
### [shareIdentity()](https://github.com/dxos/dxos/blob/bfdd5a17b/packages/sdk/client/src/services/shell.ts#L97)
...
### [shareSpace(options)](https://github.com/dxos/dxos/blob/bfdd5a17b/packages/sdk/client/src/services/shell.ts#L126)
