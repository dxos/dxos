# Class `DocumentType`
<sub>Declared in [packages/sdk/client/src/testing/data.ts:14](https://github.com/dxos/dxos/blob/d7adf231c/packages/sdk/client/src/testing/data.ts#L14)</sub>
...
## Properties
### [content](https://github.com/dxos/dxos/blob/d7adf231c/packages/sdk/client/src/testing/data.ts#L16)
...
### [title](https://github.com/dxos/dxos/blob/d7adf231c/packages/sdk/client/src/testing/data.ts#L15)
Type: <code>string</code>
