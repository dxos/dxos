...
---
# Functions
### [mountDevtoolsHooks(options)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/devtools/devtools.ts#L71)
...
### [unmountDevtoolsHooks()](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/devtools/devtools.ts#L278)
...
### [fullyQualifiedId(object)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/echo/util.ts#L35)
...
### [getSpace(\[object\])](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/echo/util.ts#L12)
...
### [isSpace(object)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/echo/util.ts#L29)
...
### [createClientServices(config, \[createWorker\], \[observabilityGroup\], \[signalTelemetryEnabled\])](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/services/client-services-factory.tsx#L19)
...
### [fromAgent(options)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/services/agent.ts#L31)
...
### [fromHost(config, \[params\], \[observabilityGroup\], \[signalTelemetryEnabled\])](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/services/local-client-services.ts#L25)
...
### [fromSocket(url, \[authenticationToken\])](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/services/socket.ts#L14)
...
### [fromWorker(config, options)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/services/worker-client-services.ts#L24)
...
### [getUnixSocket(profile, protocol)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/services/agent.ts#L21)
...
### [createInitializedClientsWithContext(ctx, count, \[options\])](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/testing/utils.ts#L54)
...
### [joinCommonSpace(options, \[spaceKey\])](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/testing/test-builder.ts#L201)
...
### [syncItemsAutomerge(db1, db2)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/testing/test-builder.ts#L193)
...
### [testSpaceAutomerge(createDb, checkDb)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/testing/test-builder.ts#L185)
...
### [waitForSpace(client, spaceKey, options)](https://github.com/dxos/dxos/blob/4cb70f94e/packages/sdk/client/src/testing/utils.ts#L22)
