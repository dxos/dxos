...
---
# Functions
### [mountDevtoolsHooks(options)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/devtools/devtools.ts#L54)
...
### [unmountDevtoolsHooks()](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/devtools/devtools.ts#L202)
...
### [fullyQualifiedId(object)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/echo/util.ts#L32)
...
### [getSpace(object)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/echo/util.ts#L12)
...
### [isSpace(object)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/echo/util.ts#L25)
...
### [createClientServices(config, \[createWorker\], \[observabilityGroup\], \[signalTelemetryEnabled\])](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/services/client-services-factory.tsx#L21)
...
### [fromAgent(options)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/services/agent.ts#L31)
...
### [fromHost(config, \[params\], \[observabilityGroup\], \[signalTelemetryEnabled\])](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/services/local-client-services.ts#L28)
...
### [fromIFrame(config, options)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/services/utils.ts#L21)
...
### [fromSocket(url, \[authenticationToken\])](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/services/socket.ts#L14)
...
### [fromWorker(config, options)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/services/worker-client-services.ts#L24)
...
### [getUnixSocket(profile, protocol)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/services/agent.ts#L21)
...
### [joinCommonSpace(options, \[spaceKey\])](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/testing/test-builder.ts#L197)
...
### [syncItemsAutomerge(db1, db2)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/testing/test-builder.ts#L189)
...
### [testSpaceAutomerge(createDb, checkDb)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/testing/test-builder.ts#L181)
...
### [waitForSpace(client, spaceKey, options)](https://github.com/dxos/dxos/blob/3ca6d230f/packages/sdk/client/src/testing/utils.ts#L16)
