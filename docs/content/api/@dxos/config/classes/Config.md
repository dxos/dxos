# Class `Config`
<sub>Declared in [sdk/config/src/config.ts:126](https://github.com/dxos/dxos/blob/56c97ac85/packages/sdk/config/src/config.ts#L126)</sub>
...
## Constructors
### [constructor(config, objects)](https://github.com/dxos/dxos/blob/56c97ac85/packages/sdk/config/src/config.ts#L133)
...
## Properties
### [values](https://github.com/dxos/dxos/blob/56c97ac85/packages/sdk/config/src/config.ts#L140)
...
## Methods
### [find(path, test)](https://github.com/dxos/dxos/blob/56c97ac85/packages/sdk/config/src/config.ts#L161)
...
### [get(key, \[defaultValue\])](https://github.com/dxos/dxos/blob/56c97ac85/packages/sdk/config/src/config.ts#L151)
...
### [getOrThrow(key)](https://github.com/dxos/dxos/blob/56c97ac85/packages/sdk/config/src/config.ts#L175)
