...
### [env](https://github.com/dxos/dxos/blob/main/packages/sdk/config/src/plugin/types.ts#L38)
Type: <code>string[]</code>
...
### [mode](https://github.com/dxos/dxos/blob/main/packages/sdk/config/src/plugin/types.ts#L26)
Type: <code>string</code>
...
### [publicUrl](https://github.com/dxos/dxos/blob/main/packages/sdk/config/src/plugin/types.ts#L33)
Type: <code>string</code>
