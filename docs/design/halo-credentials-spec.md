...
***HALO Party*** - 
Set of credentials, and data (e.g., preferences) for a given agent (i.e., identity). Replicated between all devices of the identity.

***Identity key*** - 
Public/private key pair for agents.

***Invitation*** - 
Process (sometimes interactive) of admitting a new member to a party (data party or HALO party).

***KeyChain*** - 
Set of credential messages establishing a chain of trust between keys.
