...
Starting in October, Jess and Zhenya from DXOS started hosting weekly Office Hours. Office Hours are held on Thursdays from 11-12 PT via an event in the `#general` voice channel of our DXOS [Discord](https://dxos.org/discord) server. Stop by and ask questions or get a demo of some super-beta stuff (LLM integration, universal drag-n-drop, etc).
