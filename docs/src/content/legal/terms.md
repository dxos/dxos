---
title: 'DXOS Terms of Service'
description: 'DXOS terms of use'
---
...
- Using the Service for its intended purposes without causing harm or disruption.

The following activities are explicitly prohibited and may result in immediate termination of Service:

- Illegal Activities: Engaging in any activity that violates local, state, national, or international law.
- System Security: Attempting to interfere with, disrupt, reveal or exploit weaknesses in the security or functionality of our Services, system, or software. Using excessive resources, or engaging in activities that disrupt the normal operation of the Service.
- Harassment and Abuse: Using the Service to harass, abuse, or threaten others, including sending unsolicited communications or spreading harmful or offensive content.
