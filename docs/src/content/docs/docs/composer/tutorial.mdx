...
Each section below will explain a different [`PluginModule`](/docs/composer/introduction#pluginmodule), its [`ActivationEvent`](/docs/composer/introduction#activationevent), the [`Capability`](/docs/composer/introduction#capability) it contributes and how that fits within the greater context of the application.
...
An optional `inputSchema` can be provided if the object has properties which may need to be configured on creation.
  ...
  activate: () =>
    contributes(Capabilities.Metadata, {
      ...
      metadata: {
        ...
        inputSchema: MapAction.CreateMap, // Optional.
