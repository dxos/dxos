...
This section describes how to obtain [HALO identity](/docs/halo/introduction) in `react`.
...
Once identity is established, a [`space`](/docs/echo/react/api) must be created or joined in order to manipulate data.
