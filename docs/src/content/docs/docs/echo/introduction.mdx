...
1. <Badge text="Peer A" variant='tip' /> listens on the peer network for peers interested in a specific [invite code](/docs/additional-resources/glossary#invitation-code) it generated.
