...
[@dxos/echo-db](../modules/dxos_echo_db.md).SpaceNotFoundError
...
[packages/core/echo/echo-db/src/packlets/errors/errors.ts:30](https://github.com/dxos/dxos/blob/main/packages/core/echo/echo-db/src/packlets/errors/errors.ts#L30)
