...
[packages/core/echo/echo-db/src/packlets/errors/errors.ts:36](https://github.com/dxos/dxos/blob/main/packages/core/echo/echo-db/src/packlets/errors/errors.ts#L36)
