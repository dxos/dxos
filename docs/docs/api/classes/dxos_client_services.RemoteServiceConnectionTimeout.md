...
[@dxos/client-services](../modules/dxos_client_services.md).RemoteServiceConnectionTimeout
...
[packages/sdk/client-services/src/errors.ts:16](https://github.com/dxos/dxos/blob/main/packages/sdk/client-services/src/errors.ts#L16)
