...
[@dxos/rpc](../modules/dxos_rpc.md).RpcNotOpenError
...
[packages/core/mesh/rpc/src/errors.ts:44](https://github.com/dxos/dxos/blob/main/packages/core/mesh/rpc/src/errors.ts#L44)
