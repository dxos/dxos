# Variable: ERR\_GREET\_ALREADY\_CONNECTED\_TO\_SWARM
...
[packages/halo/credentials/src/greet/error-codes.ts:57](https://github.com/dxos/dxos/blob/main/packages/halo/credentials/src/greet/error-codes.ts#L57)
