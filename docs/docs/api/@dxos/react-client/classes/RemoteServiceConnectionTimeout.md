...
<sub>Declared in [packages/core/protocols/dist/esm/src/errors/errors.d.ts:56]()</sub>
...
Returns: <code>[RemoteServiceConnectionTimeout](/api/@dxos/react-client/classes/RemoteServiceConnectionTimeout)</code>
